/*
	Rollup.js v0.20.5
	Wed Nov 04 2015 17:59:40 GMT-0500 (EST) - commit 161a44731935af51ab30e7f29fee1b97eb2b0a89
			...
			if (node.type === 'VariableDeclaration') {
				(function () {
					...
					node.declarations.forEach(function (declaration) {
						return scope.addDeclaration(declaration, isBlockDeclaration, true);
					});
				})();
			}
...
var Module = (function () {
	...
	Module.prototype.addImport = function addImport(statement) {
		...
		node.specifiers.forEach(function (specifier) {
			...
			if (_this5.imports[localName]) {
				...
				err.file = _this5.id;
				err.loc = getLocation$1(_this5.code, specifier.start);
				throw err;
			}
	...
	Module.prototype.traceExport = function traceExport(name) {
		...
		for (var i = 0; i < this.exportAllModules.length; i += 1) {
			...
			var declaration = _module2.traceExport(name);
...
var Bundle = (function () {
	function Bundle(options) {
		...
		this.resolveId = first$1(this.plugins.map(function (plugin) {
			return plugin.resolveId;
		}).filter(Boolean).concat(resolveId));

		this.load = first$1(this.plugins.map(function (plugin) {
			return plugin.load;
