    ...
    promisedTest("#1842 - Should set the unique flag for primKey to true", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, Dexie__default["default"].delete("PrimKey1842")];
                case 1:
                    // First test if flag is correctly set when creating new store
                    // version.ts, _parseStoresSpec()
                    _a.sent();
                    db = new Dexie__default["default"]("PrimKey1842");
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, Dexie__default["default"].getDatabaseNames()];
                case 7:
                    databases = _a.sent();
    ...
    */
    ...
    promisedTest("Dexie 4: It should work having two versions of the DB opened at the same time as long as they have a compatible schema", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (typeof ((_a = Dexie__default["default"].Observable) === null || _a === void 0 ? void 0 : _a.version) === 'string') {
                ...
                case 1:
                    _b.sent();
                    db1 = new Dexie__default["default"](DBNAME);
                    db1.version(1).stores({
                        friends: "id"
                    });
                    db2 = new Dexie__default["default"](DBNAME);
                    db2.version(2).stores({
                        friends: "id, name, age",
                        pets: 'id, friendId, kind'
                    });
                ...
                case 12:
                    ...
                    return [4 /*yield*/, new Dexie__default["default"](DBNAME).open()];
                case 13:
                    db = _b.sent();
    ...
    promisedTest("Dexie 4: An attached upgrader on version 2 and 3 shall run even if version 1 was reused for schema manipulation more than 20 times", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (typeof ((_b = Dexie__default["default"].Observable) === null || _b === void 0 ? void 0 : _b.version) === 'string') {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, F(QUnit.ok, QUnit.equal, Dexie__default["default"], db$4, Dexie.liveQuery).catch(function (err) { return QUnit.ok(false, 'final catch: ' + err); })];
            }
        });
    }); });
