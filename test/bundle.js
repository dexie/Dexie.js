...
promisedTest("txcommitted event", function () { return __awaiter(void 0, void 0, void 0, function () {
    function txCommitted(observabilitySet) {
        Dexie__default.extendObservabilitySet(os, observabilitySet);
        signal.resolve(observabilitySet);
    }
    var signal, os, itemsChanges, fooChanges;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                signal = new Signal();
                os = {};
                return [4 /*yield*/, db$11.open()];
            case 1:
                _a.sent();
                Dexie__default.on('txcommitted', txCommitted);
                return [4 /*yield*/, db$11.transaction('rw', db$11.items, db$11.foo, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, db$11.items.add({ id: 4, name: "aiwo1" })];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, db$11.items.add({ id: 7, name: "kjlj" })];
                                case 2:
                                    _a.sent();
                                    return [4 /*yield*/, db$11.foo.add({ name: "jkll" })];
                                case 3:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
            ...
            case 2:
                ...
                _a.label = 3;
            case 3:
                if (!(!os.TestLiveQuery || !os.TestLiveQuery.items || os.TestLiveQuery.items.keys.indexOf(4) === -1)) return [3 /*break*/, 5];
            ...
            case 4:
                ...
                return [3 /*break*/, 3];
            case 5:
                QUnit.ok(!!os.TestLiveQuery, "Got changes in our table name TestLiveQuery");
                itemsChanges = os.TestLiveQuery.items;
                QUnit.ok(itemsChanges, "Got changes for items table");
                deepEqual(itemsChanges.keys, [4, 7], "Item changes on concattenated keys");
                fooChanges = os.TestLiveQuery.foo;
                QUnit.ok(fooChanges, "Got changes for foo table");
                Dexie__default.on('txcommitted').unsubscribe(txCommitted);
                return [2 /*return*/];
        }
    });
}); });
...
promisedTest("subscribe to keys", function () { return __awaiter(void 0, void 0, void 0, function () {
    var signal1, signal2, count1, count2, debugTxCommitted, sub1, res1, sub2, res2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                signal1 = new Signal(), signal2 = new Signal();
                count1 = 0, count2 = 0;
                debugTxCommitted = function (set) { return console.debug("txcommitted", set); };
                Dexie__default.on('txcommitted', debugTxCommitted);
