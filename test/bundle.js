(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    MAX_LONG_STACKS = 20, ZONE_ECHO_LIMIT = 100, _a = typeof Promise === 'undefined' ?
        [] :
        (function () {
        ...
        })(), resolvedNativePromise = _a[0], nativePromiseProto = _a[1], resolvedGlobalPromise = _a[2], nativePromiseThen = nativePromiseProto && nativePromiseProto.then;
    ...
    ***************************************************************************** */
    ...
    var mutsAndExpects = function () { return [
        ...
        [
            ...
            {
                outboundToArray: __spreadArray([{ num: 1, name: "A" }, { num: 2, name: "B" }, { num: 3, name: "C" }], bulkOutbounds),
                outbound_above_z49: __spreadArray([], bulkOutbounds.filter(function (o) { return o.name > "z49"; }))
            },
        ...
        [
            ...
            {
                friendsOver18: __spreadArray([], bulkFriends.filter(function (f) { return f.age > 18; }))
            }
        ],
        // bulkDelete
        [
            ...
            {
                friendsOver18: __spreadArray([], bulkFriends.filter(function (f) { return f.age === 20; }))
            }
        ],
        // multiEntry
        [
