...
function promisedTest(name, num, asyncFunction) {
    if (!asyncFunction) {
        asyncFunction = num;
        QUnit.asyncTest(name, function () {
            return asyncFunction().catch(function (e) {
                return QUnit.ok(false, e.stack || e);
            }).then(QUnit.start);
        });
    } else {
...
QUnit.asyncTest("#323 @gitawego's post. Should not fail unexpectedly on readonly properties", function () {
    ...
    db$1.foo.mapToClass(Foo);

    db$1.transaction('rw', db$1.foo, function () {
        db$1.foo.put({ id: 1 });
        db$1.foo.where('id').equals(1).modify({
            synced: true
        });
    }).catch(function (e) {
        ...
        return db$1.foo.toCollection().sortBy('synced');
    }).then(function (array) {
        ...
        while (1) {
            switch (_context4.prev = _context4.next) {
                case 0:
                    NUM_UPDATES = 2000;
                    _context4.next = 3;
                    return db$1.transaction('rw', db$1.foo, regeneratorRuntime.mark(function _callee3() {
                        var i;
                        return regeneratorRuntime.wrap(function _callee3$(_context3) {
                            while (1) {
                                switch (_context3.prev = _context3.next) {
                                    case 0:
                                        _context3.next = 2;
                                        return db$1.foo.put({ id: 1, value: 0 });

                                    case 2:
                                        for (i = 0; i < NUM_UPDATES; ++i) {
                                            db$1.foo.where('id').equals(1).modify(function (item) {
                                                return ++item.value;
                                            });
                                        }
                                        _context3.next = 5;
...
db$3.on("populate", function () {
    var folders = db$3.table("folders");
    var files = db$3.table("files");
...
db$4.on("populate", function () {
    db$4.users.add({ id: 1, first: "David", last: "Fahlander", username: "dfahlander", email: ["david@awarica.com", "daw@thridi.com"], pets: ["dog"] });
    db$4.users.add({ id: 2, first: "Karl", last: "Cedersköld", username: "kceder", email: ["karl@ceder.what"], pets: [] });
});
...
QUnit.asyncTest("Transaction should work when returning native Promise in transaction scope", function () {
    db$6.transaction('rw', db$6.users, function (trans) {
        ...
        return NativePromise.resolve().then(function () {
            ...
            return db$6.users.add({ username: "barfoo" }); // Will only work on Chrome, Opera and Edge as of Oktober 6, 2016.
        }).then(function () {
            QUnit.ok(Dexie.currentTransaction === trans, "Dexie.currentTransaction should persted through the native promise!");
            return db$6.users.count();
        });
    }).then(function (count) {
...
var db$7 = new Dexie("TestDBTranx");
...
QUnit.asyncTest("Should be able to use global Promise within transaction scopes", function () {
    db$7.transaction('rw', db$7.items, function (trans) {
        return window.Promise.resolve().then(function () {
            ...
            return db$7.items.add({ id: "foobar" });
        }).then(function () {
            return Promise.resolve();
        }).then(function () {
            QUnit.ok(Dexie.currentTransaction == trans, "Transaction scopes should persist through Promise.resolve()");
            return db$7.items.get('foobar');
        });
...
QUnit.asyncTest("Should be able to use native async await", function () {
    Promise.resolve().then(function () {
        ...
        return f(QUnit.ok, QUnit.equal, Dexie, db$7);
    }).catch(function (e) {
...
QUnit.asyncTest("Must not leak PSD zone", function () {
    ...
    F(QUnit.ok, QUnit.equal, Dexie, db$7).catch(function (e) {
        return QUnit.ok(false, e.stack || e);
    }).then(QUnit.start);
});
...
QUnit.asyncTest("Must not leak PSD zone2", function () {
    ...
    db$7.transaction('rw', db$7.items, function () {
        var trans = Dexie.currentTransaction;
        ...
        return Promise.resolve().then(function () {
            ...
            return f(QUnit.ok, QUnit.equal, Dexie, trans, NativePromise$1, db$7);
        }).catch(function (e) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    _context2.next = 2;
                    return db$7.transaction('rw', db$7.items, regeneratorRuntime.mark(function _callee() {
                        var x, all;
                        return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 2:
                                        x = _context.sent;
                                        _context.next = 5;
                                        return db$7.items.bulkAdd([{ id: 'a' }, { id: 'b' }]);

                                    case 5:
                                        _context.next = 7;
                                        return Promise.all([db$7.items.get('a'), db$7.items.get('b')]);
        ...
        while (1) {
            switch (_context3.prev = _context3.next) {
                case 0:
                    ...
                    _context3.next = 3;
                    return db$7.transaction('rw', db$7.items, function () {
                        var trans = Dexie.currentTransaction;
        ...
        while (1) {
            switch (_context6.prev = _context6.next) {
                case 0:
                    ...
                    _context6.next = 5;
                    return regeneratorRuntime.awrap(db$7.transaction('rw', db$7.items, function _callee5() {
    ...
    return regeneratorRuntime.async(function _callee15$(_context15) {
        while (1) {
            switch (_context15.prev = _context15.next) {
                case 0:
                    _context15.next = 2;
                    return regeneratorRuntime.awrap(db$7.transaction('rw', db$7.items, function _callee14() {
                        var trans;
                            ...
                            while (1) {
                                switch (_context14.prev = _context14.next) {
                                    case 0:
                                        ...
                                        _context14.next = 4;
                                        return regeneratorRuntime.awrap(db$7.items.add({ id: 'foo' }));
                                    ...
                                    case 10:
                                        ...
                                        _context14.next = 13;
                                        return regeneratorRuntime.awrap(db$7.transaction('r', db$7.items, function _callee7(innerTrans) {
                                            var x;
                                                ...
                                                while (1) {
                                                    switch (_context7.prev = _context7.next) {
                                                        case 0:
                                                            ...
                                                            _context7.next = 5;
                                                            return regeneratorRuntime.awrap(db$7.items.get(1));
                                            ...
                                            return regeneratorRuntime.async(function _callee11$(_context11) {
                                                while (1) {
                                                    switch (_context11.prev = _context11.next) {
                                                        case 0:
                                                            _context11.next = 2;
                                                            return regeneratorRuntime.awrap(Promise.all([db$7.transaction('r', db$7.items, function _callee9() {
                                                                return regeneratorRuntime.async(function _callee9$(_context9) {
                                                                    while (1) {
                                                                        switch (_context9.prev = _context9.next) {
                                                                            ...
                                                                            case 2:
                                                                                _context9.next = 4;
                                                                                return regeneratorRuntime.awrap(db$7.items.get(2));
                                                            ...
                                                            }), db$7.transaction('r', db$7.items, function _callee10() {
...
var db$8 = new Dexie("TestDBException");
db$8.version(1).stores({ users: "id,first,last,&username,&*email,*pets" });
db$8.on("populate", function (trans) {
    db$8.users.add({ id: 1, first: "David", last: "Fahlander", username: "dfahlander", email: ["david@awarica.com", "daw@thridi.com"], pets: ["dog"] });
    db$8.users.add({ id: 2, first: "Karl", last: "Cedersköld", username: "kceder", email: ["karl@ceder.what"], pets: [] });
});
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    _context2.next = 2;
                    return db$8.transaction("rw", db$8.users, regeneratorRuntime.mark(function _callee() {
                        var id;
                        return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    case 0:
                                        _context.next = 2;
                                        return db$8.users.add({ id: 3, first: "Foo", last: "Bar", username: "foobar" });
                                    ...
                                    case 2:
                                        ...
                                        QUnit.equal(id, 3);
                                        _context.next = 6;
                                        return db$8.users.where('id').equals(null).toArray();
                ...
                case 2:
                    _context2.next = 4;
                    return db$8.users.where('first').equals("Foo").count();
                ...
                case 4:
                    ...
                    return db$8.transaction("rw", db$8.users, function () {
                        db$8.users.add({ id: 3, first: "Foo", last: "Bar", username: "foobar" });
                        db$8.users.where('id').equals(null).toArray(function (res) {
...
QUnit.asyncTest("eventError-transaction-catch", function () {
    db$8.transaction("rw", db$8.users, function () {
        db$8.users.add({ id: 100, username: "dfahlander" }).then(function () {
...
QUnit.asyncTest("eventError-request-catch", function () {
    db$8.transaction("rw", db$8.users, function () {
        ...
        db$8.users.add({ id: 101, first: "Trazan", last: "Apansson", username: "tapan", email: ["trazan@apansson.barnarne"], pets: ["monkey"] }).then(function (id) {
...
QUnit.asyncTest("exceptionThrown-request-catch", function () {
    db$8.transaction("r", db$8.users, function () {
        db$8.users.where("username").equals("apa").toArray(function () {
            db$8.users.where("username").equals("kceder").toArray().then(function () {
                return "a";
            }).then(function () {
...
QUnit.asyncTest("exceptionThrown-iteration-should-abort-when-using-hook", function () {
    ...
    db$8.users.hook('deleting', deletingHook);
    db$8.transaction('rw', db$8.users, function () {

        function deleteKarls() {
            db$8.users.toCollection().modify(function (user) {
                delete this.value;
...
QUnit.asyncTest("Issue #67 - Exception can be thrown in WhereClause methods", function () {
    try {
        Dexie.Promise.all([
        // WhereClause.equals()
        db$8.users.where('first').equals(false) // Using a non-valid key (boolean) must fail but as a Promise rejection, not an exception.
        ...
        // WhereClause.above()
        db$8.users.where('first').above(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.above() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.aboveOrEqual()
        db$8.users.where('first').aboveOrEqual(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.aboveOrEqual() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.below()
        db$8.users.where('first').below(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.below() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.belowOrEqual()
        db$8.users.where('first').belowOrEqual(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.belowOrEqual() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.anyOf()
        db$8.users.where('first').anyOf([undefined, null, false]) // Using a non-valid key (undefined, false) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.anyOf() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.between()
        db$8.users.where('first').between(false, true) // Using a non-valid key (boolean) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.between() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.equalsIgnoreCase()
        db$8.users.where('first').equalsIgnoreCase(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.equalsIgnoreCase() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.startsWith()
        db$8.users.where('first').startsWith(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
            QUnit.ok(true, "Invalid key passed to WhereClause.startsWith() returned as a failed Promise and not an exception.");
        }),
        // WhereClause.startsWithIgnoreCase()
        db$8.users.where('first').startsWithIgnoreCase(undefined) // Using a non-valid key (undefined) must fail but as a Promise rejection, not an exception.
        .toArray().catch(function (err) {
...
QUnit.asyncTest("Issue #67 - Regression test - Transaction still fails if error in key", function () {
    db$8.transaction('rw', db$8.users, function () {
        db$8.users.where('first').above("").delete().then(function (num) {
            QUnit.ok(true, num + " users deleted");
            db$8.users.where('first').above(undefined).delete();
        });
    }).then(function () {
    ...
    Dexie.Promise.resolve(Promise.reject(new Error("Converting a rejected standard promise to Dexie.Promise but don't catch it"))).finally(function () {
        ...
        Dexie.delete("testdb").then(function () {
            ...
            db.delete().finally(function () {
                ...
                QUnit.equal(errorList[5], "FOO", "FOO");
                // cleanup:
