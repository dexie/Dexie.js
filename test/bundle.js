(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function liveQueryUnitTester(lq, _a) {
        var _this = this;
        var _b = _a === void 0 ? { graceTime: 0 } : _a, graceTime = _b.graceTime;
        var currentVal;
        var currentError = null;
        var signal = function () { };
        var reject = function () { };
        var querying = 0;
        var subscription = Dexie.liveQuery(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return {
            waitNextValue: function (timeout) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, tester.waitNextValue()];
                case 2:
                    items = _a.sent();
    ...
    promisedTest("Issue 2058 - related but with bulkAdd and constraint error on duplicate primary keys.", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tester, items, promise, itemsToAdd;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
