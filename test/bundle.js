        ...
        return Promise.all(trans.storeNames.filter(function (tableName) {
            ...
            return db.table(tableName).each(function (item, cursor) {
                ...
                return Promise.all(Object.keys(items).map(function (key) {
                    var item = items[key];
                    var initialItem = initialItems[key];
                    if (!initialItem) return db.table(tableName).delete(item.key);
                    return Promise.resolve();
                }));
            });
        }));
        ...
        while (1) {
            switch (_context11.prev = _context11.next) {
                ...
                case 9:
                    ...
                    _context11.next = 13;
                    return db.users.bulkPut([{ id: lastId - 3, first: "Foo2", last: "BarA" }, // Will update "Foo Bar" to "Foo2 BarA"
...
promisedTest("where({key: value})", function _callee2() {
    ...
    return regeneratorRuntime.async(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    _context2.next = 2;
                    return regeneratorRuntime.awrap(db$2.files.where({ filename: "README" }).first());
                ...
                case 2:
                    ...
                    _context2.next = 7;
                    return regeneratorRuntime.awrap(db$2.files.get({ filename: "README", extension: ".TXT" }));
                ...
                case 7:
                    ...
                    _context2.next = 11;
                    return regeneratorRuntime.awrap(db$2.files.get({ filename: "apa", extension: "otto" }));

                case 11:
                    noResult = _context2.sent;

                    QUnit.ok(!noResult, "Should not get a result when querying non-existing stuff");

                    // Friends have single indexes on "name" and "age"
                    _context2.next = 15;
                    return regeneratorRuntime.awrap(db$2.friends.add({ name: "Ulla Bella", number: 888, age: 88 }));

                case 15:
                    _context2.next = 17;
                    return regeneratorRuntime.awrap(db$2.chaps.add({ name: "Ulla Bella", number: 888, age: 88 }));

                case 17:
                    _context2.next = 19;
                    return regeneratorRuntime.awrap(db$2.folders.add({ name: "Ulla Bella", number: 888, age: 88 }));

                case 19:
                    _context2.next = 21;
                    return regeneratorRuntime.awrap(db$2.friends.get({ name: "Ulla Bella", number: 888 }));

                case 21:
                    ullaBella1 = _context2.sent;

                    QUnit.ok(!!ullaBella1, "Should be able to query multiple columns even when only one of them is indexed");
                    _context2.next = 25;
                    return regeneratorRuntime.awrap(db$2.chaps.get({ name: "Ulla Bella", number: 888 }));

                case 25:
                    ullaBella2 = _context2.sent;

                    QUnit.ok(!!ullaBella2, "Should be able to query multiple columns. This time utilizing compound index.");
                    _context2.next = 29;
                    return regeneratorRuntime.awrap(db$2.chaps.get({ number: 888, name: "Ulla Bella" }));

                case 29:
                    ullaBella3 = _context2.sent;

                    QUnit.ok(!!ullaBella3, "Should be able to utilize compound index no matter the order of criterias.");
                    _context2.next = 33;
                    return regeneratorRuntime.awrap(db$2.folders.get({ name: "Ulla Bella", number: 888 }).then(function (ulla) {
...
promisedTest("orderBy(['idx1','idx2'])", function _callee3() {
    var files;
        ...
        while (1) {
            switch (_context3.prev = _context3.next) {
                ...
                case 3:
                    ...
                    _context3.next = 6;
                    return regeneratorRuntime.awrap(db$2.files.orderBy(["filename", "extension"]).toArray());
...
QUnit.asyncTest("Issue #95 Nested transactions fails if parent transaction don't execute any operation", function () {
    function smallChild() {
        return db$3.transaction('rw', db$3.users, db$3.pets, function () {
            ...
            return db$3.users.add({ // Here: Test succeeded if removing the 'return' statement here!
                username: 123,
                value: 'val'
            }).then(function (res) {
...
QUnit.asyncTest("Dexie.currentTransaction in CRUD hooks", 53, function () {
    ...
    function doTheTests() {
        db$3.users.add({ username: "monkey1" });
        db$3.users.add({ username: "monkey1" }).catch(function (ex) {
        ...
        db$3.users.bulkAdd([{ username: "monkey1" }, { username: "monkey2" }]).then(function () {
        ...
        db$3.users.where("username").equals("monkey1").modify({
            name: "Monkey 1"
        });
        db$3.users.where("username").equals("monkey1").modify(function (user) {
            user.username = "monkey2"; // trigger updating.onerror
        }).catch(function (ex) {
            QUnit.ok(true, "Should fail modifying primary key");
        });
        db$3.users.toArray();
        db$3.users.delete("monkey2");
        return db$3.users.delete("monkey1");
    }
...
promisedTest("waitFor()", function _callee4() {
    return regeneratorRuntime.async(function _callee4$(_context4) {
        while (1) {
            switch (_context4.prev = _context4.next) {
                case 0:
                    _context4.next = 2;
                    return regeneratorRuntime.awrap(db$3.transaction('rw', db$3.users, function _callee3(trans) {
                        var result;
                        return regeneratorRuntime.async(function _callee3$(_context3) {
                            while (1) {
                                switch (_context3.prev = _context3.next) {
                                    case 0:
                                        _context3.next = 2;
                                        return regeneratorRuntime.awrap(trans.waitFor(sleep(100)));

                                    case 2:
                                        _context3.next = 4;
                                        return regeneratorRuntime.awrap(trans.users.put({ username: "testingtesting" }));
                                    ...
                                    case 6:
                                        _context3.next = 8;
                                        return regeneratorRuntime.awrap(trans.users.get("testingtesting"));
                                    ...
                                    case 8:
                                        ...
                                        // With timeout
                                        _context3.next = 13;
                                        return regeneratorRuntime.awrap(Dexie.waitFor(sleep(2000), 10) // Timeout of 10 ms.
                                        .then(function () {
                                    ...
                                    case 13:
                                        _context3.next = 15;
                                        return regeneratorRuntime.awrap(Dexie.waitFor(function _callee() {
                                                ...
                                                while (1) {
                                                    switch (_context.prev = _context.next) {
                                                        ...
                                                        case 3:
                                                            ...
                                                            _context.next = 6;
                                                            return regeneratorRuntime.awrap(trans.users.count().then(function () {
                                    ...
                                    case 17:
                                        ...
                                        // Subtransaction
                                        _context3.next = 23;
                                        return regeneratorRuntime.awrap(db$3.transaction('r', db$3.users, regeneratorRuntime.mark(function _callee2(subTrans) {
                                            var count;
                                            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                                                while (1) {
                                                    switch (_context2.prev = _context2.next) {
                                    ...
                                    case 23:
                                        _context3.next = 25;
                                        return regeneratorRuntime.awrap(Promise.all([trans.waitFor(sleep(10)), trans.waitFor(sleep(10)), trans.waitFor(sleep(10))]));
...
promisedTest("Dexie.waitFor() outside transaction", function _callee6() {
    ...
    return regeneratorRuntime.async(function _callee6$(_context6) {
        while (1) {
            switch (_context6.prev = _context6.next) {
                case 0:
                    _context6.next = 2;
                    return regeneratorRuntime.awrap(Dexie.waitFor(sleep(10).then(function () {
                        return true;
                    })));
                ...
                case 2:
                    ...
                    codeExecuted = false;
                    _context6.next = 7;
                    return regeneratorRuntime.awrap(Dexie.waitFor(function _callee5() {
...
promisedTest("Dexie.waitFor() TransactionInactiveError", function _callee8() {
    return regeneratorRuntime.async(function _callee8$(_context8) {
        while (1) {
            switch (_context8.prev = _context8.next) {
                case 0:
                    _context8.next = 2;
                    return regeneratorRuntime.awrap(db$3.transaction('r', db$3.users, function _callee7() {
                            ...
                            while (1) {
                                switch (_context7.prev = _context7.next) {
                                    ...
                                    case 2:
                                        _context7.prev = 2;
                                        _context7.next = 5;
                                        return regeneratorRuntime.awrap(Dexie.waitFor(sleep(10)));
                                    ...
                                    case 8:
                                        ...
                                        QUnit.ok(_context7.t0.name == 'TransactionInactiveError' || _context7.t0.name == 'InvalidStateError', 'Got TransactionInactiveError or InvalidStateError as expected');
...
promisedTest("Promise.follow() should omit promises spawned under Dexie.ignoreTransaction()", function _callee9() {
    var resolve, reject, p, log;
    return regeneratorRuntime.async(function _callee9$(_context9) {
        while (1) {
            switch (_context9.prev = _context9.next) {
                case 0:
                    resolve = void 0, reject = void 0;
                    p = new Promise(function (res, rej) {
                        resolve = res;reject = rej;
                    });
                    log = [];
                    _context9.next = 5;
                    return regeneratorRuntime.awrap(db$3.transaction('r', db$3.users, function () {
...
promisedTest("db.transaction() should not wait for non-awaited new top-level transactions to commit", function _callee10() {
    var resolve, reject, p, log;
...
var timeout = async$1(regeneratorRuntime.mark(function _callee(promise, ms) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
...
promisedTest("#392 db.on('ready') don't fire if subscribed while waiting other promise-returning subscriber", function _callee6() {
        ...
        while (1) {
            switch (_context6.prev = _context6.next) {
                case 0:
                    ...
                    _context6.next = 6;
                    return regeneratorRuntime.awrap(db.open());
                ...
                case 6:
                    ...
                    _context6.next = 9;
                    return regeneratorRuntime.awrap(Dexie.Promise.resolve());
        ...
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    ...
                    _context2.prev = 1;
                    _context2.next = 4;
                    return db$4.transaction('rw', 'friends', 'pets', regeneratorRuntime.mark(function _callee() {
        ...
        while (1) {
            switch (_context5.prev = _context5.next) {
                case 0:
                    _context5.prev = 0;
                    _context5.next = 3;
                    return db$4.transaction('rw', 'pets', regeneratorRuntime.mark(function _callee4() {
                        return regeneratorRuntime.wrap(function _callee4$(_context4) {
                            while (1) {
                                switch (_context4.prev = _context4.next) {
                                    case 0:
        ...
        while (1) {
            switch (_context7.prev = _context7.next) {
                case 0:
                    _context7.prev = 0;
                    _context7.next = 3;
                    return db$4.transaction('rw', 'pets', regeneratorRuntime.mark(function _callee6() {
                        return regeneratorRuntime.wrap(function _callee6$(_context6) {
                            while (1) {
                                switch (_context6.prev = _context6.next) {
                                    case 0:
...
QUnit.asyncTest("Should allow yielding an array of different kind of any kind of promise", function () {
    spawn(regeneratorRuntime.mark(function _callee12() {
        var results;
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
            while (1) {
                switch (_context12.prev = _context12.next) {
...
QUnit.asyncTest("Throw after yield 1", function () {
    spawn(regeneratorRuntime.mark(function _callee13() {
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
            while (1) {
                switch (_context13.prev = _context13.next) {
                    case 0:
...
QUnit.asyncTest("Throw after yield 2", function () {
    Promise.resolve(spawn(regeneratorRuntime.mark(function _callee14() {
        return regeneratorRuntime.wrap(function _callee14$(_context14) {
            while (1) {
                switch (_context14.prev = _context14.next) {
                    case 0:
...
QUnit.asyncTest("Throw before yield", function () {
    Promise.resolve(spawn(regeneratorRuntime.mark(function _callee15() {
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
            while (1) {
                switch (_context15.prev = _context15.next) {
                    case 0:
...
QUnit.asyncTest("Catch rejected promise", function () {
    spawn(regeneratorRuntime.mark(function _callee16() {
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
            while (1) {
                switch (_context16.prev = _context16.next) {
                    case 0:
...
QUnit.asyncTest("Catch rejected promise in an array", function () {
    spawn(regeneratorRuntime.mark(function _callee17() {
        return regeneratorRuntime.wrap(function _callee17$(_context17) {
            while (1) {
                switch (_context17.prev = _context17.next) {
                    case 0:
...
QUnit.asyncTest("Should allow returning a promise", function () {
    spawn(regeneratorRuntime.mark(function _callee18() {
        return regeneratorRuntime.wrap(function _callee18$(_context18) {
            while (1) {
                switch (_context18.prev = _context18.next) {
                    case 0:
...
QUnit.asyncTest("Should be able to do 'return yield Promise.resolve(x);'", function () {
    spawn(regeneratorRuntime.mark(function _callee19() {
        return regeneratorRuntime.wrap(function _callee19$(_context19) {
            while (1) {
                switch (_context19.prev = _context19.next) {
                    case 0:
...
spawnedTest("Should use Promise.all where applicable", regeneratorRuntime.mark(function _callee2() {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    _context2.next = 2;
                    return db$5.transaction('rw', db$5.items, regeneratorRuntime.mark(function _callee() {
                        var x, all;
                        return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                                switch (_context.prev = _context.next) {
...
spawnedTest("Even when keeping a reference to global Promise, still maintain PSD zone states", regeneratorRuntime.mark(function _callee3() {
    var Promise;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
            switch (_context3.prev = _context3.next) {
...
spawnedTest("Sub Transactions with async await", regeneratorRuntime.mark(function _callee4() {
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
            switch (_context4.prev = _context4.next) {
                case 0:
                ...
                case 5:
                    ...
                    QUnit.ok(_context4.t0.name === 'SyntaxError', "No support for native async functions in this browser");
...
promisedTest("Should patch global Promise within transaction scopes but leave them intact outside", function _callee6() {
    var GlobalPromise;
    return regeneratorRuntime.async(function _callee6$(_context6) {
        while (1) {
            switch (_context6.prev = _context6.next) {
                case 0:
                    ...
                    _context6.next = 5;
                    return regeneratorRuntime.awrap(db$5.transaction('rw', db$5.items, function _callee5() {
                        return regeneratorRuntime.async(function _callee5$(_context5) {
                            while (1) {
                                switch (_context5.prev = _context5.next) {
                                    case 0:
...
promisedTest("Should be able to use transpiled async await", function _callee15() {
    return regeneratorRuntime.async(function _callee15$(_context15) {
        while (1) {
            switch (_context15.prev = _context15.next) {
                case 0:
                    _context15.next = 2;
                    return regeneratorRuntime.awrap(db$5.transaction('rw', db$5.items, function _callee14() {
                        var trans;
                            ...
                            while (1) {
                                switch (_context14.prev = _context14.next) {
                                    case 0:
                                        ...
                                        _context14.next = 4;
                                        return regeneratorRuntime.awrap(db$5.items.add({ id: 'foo' }));
                                    ...
                                    case 10:
                                        ...
                                        _context14.next = 13;
                                        return regeneratorRuntime.awrap(db$5.transaction('r', db$5.items, function _callee7(innerTrans) {
                                            var x;
                                            return regeneratorRuntime.async(function _callee7$(_context7) {
                                                while (1) {
                                                    switch (_context7.prev = _context7.next) {
                                                        case 0:
                                                            ...
                                                            _context7.next = 5;
                                                            return regeneratorRuntime.awrap(db$5.items.get(1));
                                            ...
                                            return regeneratorRuntime.async(function _callee11$(_context11) {
                                                while (1) {
                                                    switch (_context11.prev = _context11.next) {
                                                        case 0:
                                                            _context11.next = 2;
                                                            return regeneratorRuntime.awrap(Promise.all([db$5.transaction('r', db$5.items, function _callee9() {
                                                                return regeneratorRuntime.async(function _callee9$(_context9) {
                                                                    while (1) {
                                                                        switch (_context9.prev = _context9.next) {
                                                                            case 0:
                                                                            ...
                                                                            case 2:
                                                                                _context9.next = 4;
                                                                                return regeneratorRuntime.awrap(db$5.items.get(2));
                                                            ...
                                                            }), db$5.transaction('r', db$5.items, function _callee10() {
                                                                return regeneratorRuntime.async(function _callee10$(_context10) {
                                                                    while (1) {
                                                                        switch (_context10.prev = _context10.next) {
                                                                            case 0:
...
promisedTest("Should be able to use some simpe native async await even without zone echoing ", function _callee16() {
...
promisedTest("Should behave outside transactions as well", function _callee17() {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    _context2.next = 2;
                    return db$6.transaction("rw", db$6.users, regeneratorRuntime.mark(function _callee() {
                        var id;
                        return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                                switch (_context.prev = _context.next) {
...
QUnit.test("upgrade", function (assert) {
    ...
    function checkObjectStores(expected) {
        ...
        // Already sorted.
        var idbNames = [].concat(_toConsumableArray(db.backendDB().objectStoreNames));
    ...
    function checkTransactionObjectStores(t, expected) {
        // Add baseTables.
        expected = expected.concat(baseTables).sort();
        QUnit.deepEqual(t.storeNames.slice().sort(), expected, "Transaction stores must match expected.");
    }
...
QUnit.asyncTest("#102 Passing an empty array to anyOf throws exception", async$3(regeneratorRuntime.mark(function _callee() {
    var count;
    return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
...
spawnedTest("#360 DB unresponsive after multiple Table.update() or Collection.modify()", regeneratorRuntime.mark(function _callee4() {
        ...
        while (1) {
            switch (_context4.prev = _context4.next) {
                case 0:
                    NUM_UPDATES = 2000;
                    _context4.next = 3;
                    return db$7.transaction('rw', db$7.foo, regeneratorRuntime.mark(function _callee3() {
                        var i;
                        return regeneratorRuntime.wrap(function _callee3$(_context3) {
                            while (1) {
                                switch (_context3.prev = _context3.next) {
...
var expect = async$4(regeneratorRuntime.mark(function _callee(expected, modifyer) {
...
var verifyErrorFlows = async$4(regeneratorRuntime.mark(function _callee2(modifyer) {
            ...
            switch (_context5.prev = _context5.next) {
                ...
                case 2:
                    ...
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee3() {
                            return regeneratorRuntime.wrap(function _callee3$(_context4) {
                                while (1) {
                                    switch (_context4.prev = _context4.next) {
                                        ...
                                        case 2:
                                            _context4.next = 4;
                                            return db$8.table1.add({ id: 1 }).catch(nop);
                                        ...
                                        case 6:
                                            _context4.next = 8;
                                            return db$8.table2.add({}, 1).catch(nop);

                                        case 8:
                                            _context4.next = 10;
                                            return db$8.table1.add({ id: {} }).catch(nop);
        ...
        while (1) {
            switch (_context7.prev = _context7.next) {
                ...
                case 2:
                    _context7.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee5() {
                            return regeneratorRuntime.wrap(function _callee5$(_context6) {
                                while (1) {
                                    switch (_context6.prev = _context6.next) {
                                        ...
                                        case 2:
                                            _context6.next = 4;
                                            return db$8.table3.put({ idx: 1 }).catch(nop);
                                        ...
                                        case 6:
                                            _context6.next = 8;
                                            return db$8.table2.put({}, 1).catch(nop);

                                        case 8:
                                            _context6.next = 10;
                                            return db$8.table3.put({ id: {} }).catch(nop);
            ...
            switch (_context10.prev = _context10.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee7() {
                ...
                case 2:
                    _context10.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee8() {
                            return regeneratorRuntime.wrap(function _callee8$(_context9) {
                                while (1) {
                                    switch (_context9.prev = _context9.next) {
                                        case 0:
                                            _context9.next = 2;
                                            return db$8.table1.bulkAdd([{ id: 1 }, { id: 1 }]).catch(nop);

                                        case 2:
                                            _context9.next = 4;
                                            return db$8.table1.bulkAdd([{ id: 2 }, { id: 2 }, { id: 3 }]).catch(nop);

                                        case 4:
                                            _context9.next = 6;
                                            return db$8.table2.bulkAdd([{}, {}], [1, 1]).catch(nop);

                                        case 6:
                                            _context9.next = 8;
                                            return db$8.table2.bulkAdd([{}, {}, {}], [2, 2, 3]).catch(nop);

                                        case 8:
                                            _context9.next = 10;
                                            return db$8.table1.bulkAdd([{ id: {} }]).catch(nop);
            ...
            switch (_context13.prev = _context13.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee10() {
                ...
                case 2:
                    _context13.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee11() {
                            return regeneratorRuntime.wrap(function _callee11$(_context12) {
                                while (1) {
                                    switch (_context12.prev = _context12.next) {
                                        case 0:
                                            _context12.next = 2;
                                            return db$8.table3.bulkPut([{ idx: 1 }, { idx: 1 }]).catch(nop);

                                        case 2:
                                            _context12.next = 4;
                                            return db$8.table3.bulkPut([{ idx: 2 }, { idx: 2 }, { idx: 3 }]).catch(nop);

                                        case 4:
                                            _context12.next = 6;
                                            return db$8.table1.bulkPut([{ id: {} }]).catch(nop);
            ...
            switch (_context15.prev = _context15.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', 'table5', regeneratorRuntime.mark(function _callee13() {
            ...
            switch (_context18.prev = _context18.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee15() {
                ...
                case 2:
                    _context18.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee16() {
                            return regeneratorRuntime.wrap(function _callee16$(_context17) {
                                while (1) {
                                    switch (_context17.prev = _context17.next) {
                                        ...
                                        case 2:
                                            _context17.next = 4;
                                            return db$8.table3.put({ id: 2, idx: 1 }).catch(nop);
            ...
            switch (_context21.prev = _context21.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee18() {
                ...
                case 2:
                    _context21.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee19() {
                            return regeneratorRuntime.wrap(function _callee19$(_context20) {
                                while (1) {
                                    switch (_context20.prev = _context20.next) {
                                        ...
                                        case 2:
                                            _context20.next = 4;
                                            return db$8.table4.bulkPut([{ idx: 1 }], [2]).catch(nop);

                                        case 4:
                                            _context20.next = 6;
                                            return db$8.table3.bulkPut([{}], [{}]).catch(nop);
            ...
            switch (_context24.prev = _context24.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee21() {
                ...
                case 2:
                    _context24.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee22() {
                            return regeneratorRuntime.wrap(function _callee22$(_context23) {
                                while (1) {
                                    switch (_context23.prev = _context23.next) {
                                        ...
                                        case 2:
                                            _context23.next = 4;
                                            return db$8.table3.update(1, { idx: 2 }).catch(nop);

                                        case 4:
                                            _context23.next = 6;
                                            return db$8.table3.update(1, 3).catch(nop);
            ...
            switch (_context27.prev = _context27.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee24() {
                ...
                case 2:
                    _context27.next = 4;
                    return verifyErrorFlows(function () {
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee25() {
                            return regeneratorRuntime.wrap(function _callee25$(_context26) {
                                while (1) {
                                    switch (_context26.prev = _context26.next) {
                                        ...
                                        case 2:
                                            _context26.next = 4;
                                            return db$8.table3.where('id').equals(1).modify({ idx: 2 }).catch(nop);
            ...
            switch (_context29.prev = _context29.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee27() {
            ...
            switch (_context31.prev = _context31.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee29() {
            ...
            switch (_context33.prev = _context33.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee31() {
            ...
            switch (_context35.prev = _context35.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee33() {
            ...
            switch (_context37.prev = _context37.next) {
                case 0:
                    ...
                    return expect([{
                        ...
                        return db$8.transaction('rw', db$8.tables, regeneratorRuntime.mark(function _callee35() {
...
promisedTest('Test blobs', function _callee() {
        ...
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    ...
                    _context.next = 4;
                    return regeneratorRuntime.awrap(db$9.items.add({ id: 1, blob: blob }));

                case 4:
                    _context.next = 6;
                    return regeneratorRuntime.awrap(db$9.items.get(1));

                case 6:
                    back = _context.sent;
                    _context.next = 9;
                    return regeneratorRuntime.awrap(readBlob(back.blob));
...
promisedTest('Test blob with creating hook applied', function _callee2() {
    var updatingHook, binaryData, blob, back, arrayBuffer, resultBinaryData;
    return regeneratorRuntime.async(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    updatingHook = function updatingHook(modifications, primKey, obj, trans) {
                    ...
                    blob = new Blob([binaryData], { type: 'application/octet-binary' });
                    _context2.next = 7;
                    return regeneratorRuntime.awrap(db$9.items.add({ id: 1 }));

                case 7:
                    _context2.next = 9;
                    return regeneratorRuntime.awrap(db$9.items.put({ id: 1, blob: blob }));
...
promisedTest('binaryPrimaryKey', function _callee() {
    var back;
    return regeneratorRuntime.async(function _callee$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                ...
                case 3:
                    _context.next = 5;
                    return regeneratorRuntime.awrap(db$10.items.add({ id: new Float32Array([4.3, 2.5]), data: "string" }));

                case 5:
                    back = db$10.items.get(new Float32Array([4.3, 2.5]));

                    QUnit.equal(back[0], 4.3, "Should get float value");
                    QUnit.equal(back[1], 2.5, "Should get float value");
...
promisedTest('binaryIndex', function _callee2() {
    var x;
    return regeneratorRuntime.async(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                ...
                case 3:
                    _context2.next = 5;
                    return regeneratorRuntime.awrap(db$10.items.where('data').equals(new Uint8Array([1, 2, 3])).count());

                case 5:
                    _context2.t0 = _context2.sent;
                    QUnit.equal(_context2.t0, 1, "Should be able to query on binary key");
                    _context2.next = 9;
                    return regeneratorRuntime.awrap(db$10.items.where('data').anyOf([new Uint8Array([1, 2, 3]), new Uint8Array([4, 5, 6])]).toArray());
...
promisedTest('or query', function _callee3() {
    var a;
    return regeneratorRuntime.async(function _callee3$(_context3) {
        while (1) {
            switch (_context3.prev = _context3.next) {
                ...
                case 3:
                    _context3.next = 5;
                    return regeneratorRuntime.awrap(db$10.items.add({ id: new Float32Array([6.3, 10.5]), data: "something" }));

                case 5:
                    _context3.next = 7;
                    return regeneratorRuntime.awrap(db$10.items.where('data').equals("something").or('id').equals(new Uint8Array([1, 2, 3])).toArray());
                ...
                case 7:
                    ...
                    QUnit.ok(a.some(function (x) {
                        return x.id instanceof Float32Array;
                    }), "Should get the Float32Array id in the result");
                    QUnit.ok(a.some(function (x) {
                        return x.id == "Uint8Array";
                    }), "Should get the string-primary key in the result");
