...
QUnit.asyncTest("Must not leak PSD zone", function () {
    ...
    var mutationObserverPromise = new Promise(function (resolve) {
        new MutationObserver(function () {
            QUnit.ok(Dexie.currentTransaction === null, "Must not leak zones in patched await microtasks");
            resolve();
        ...
        Dexie.ignoreTransaction(function () {
            ...
            function promiseFlow() {
                return NativePromise$1.resolve().then(function () {
                    ...
                    return NativePromise$1.resolve();
                });
            }
