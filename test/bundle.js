...
promisedTest("bulkError by pos", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                bulkError_1 = _a.sent();
                QUnit.ok(bulkError_1 instanceof Dexie__default.BulkError, "Got BulkError");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, expect([{
                    ...
                    }], function () { return db$8.transaction('rw', db$8.table1, function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, db$8.table1.add({ id: 1 })];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, db$8.table1.put({ id: 1, authors: [{ foo: "bar" }] })];
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, db$8.table1.put({ id: 1, authors: [] })];
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, db$8.table1.put({ id: 1, authors: [{ name: "foo" }, { name: "bar" }] })];
                            case 4:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
var mutsAndExpects = function () { return [
    ...
    [
        function () { return db$11.friends.add({ name: "Foo", age: 20 }).then(function (id) { return lastFriendId = id; }); },
        {
            friendsOver18: [{ get id() { return lastFriendId; }, name: "Foo", age: 20 }]
        }
    ],
    [
        function () { return db$11.friends.put({ name: "Barbar", age: 21 }).then(function (id) { return barbarFriendId = id; }); },
        {
            friendsOver18: [
    ...
    [
        // bulkPut
        function () { return db$11.friends.bulkPut(bulkFriends, { allKeys: true }).then(function (ids) {
        ...
        {
            friendsOver18: __spreadArrays([
                { get id() { return lastFriendId; }, name: "Foo", age: 20 },
                { get id() { return barbarFriendId; }, name: "Barbar", age: 21 }
            ], bulkFriends.map(function (f) { return ({ name: f.name, age: f.age, get id() { return f.id; } }); }).filter(function (f) { return f.age > 18; })).sort(function (a, b) { return a.age - b.age; })
        }
    ],
    // bulkPut over 50 items on an outbound table:
    [
        function () { return db$11.outbound.bulkPut(bulkOutbounds); },
        {
            outboundToArray: __spreadArrays([{ num: 1, name: "A" }, { num: 2, name: "B" }, { num: 3, name: "C" }], bulkOutbounds),
            outbound_above_z49: __spreadArrays(bulkOutbounds.filter(function (o) { return o.name > "z49"; }))
        }, ["outboundStartsWithA", "outboundIdBtwnMinus1And2", "outboundAnyOf_BCD_keys"]
    ],
    // deleteRange
    [
        function () { return db$11.friends.where('id').between(0, barbarFriendId, true, true).delete(); },
        {
            friendsOver18: __spreadArrays(bulkFriends.filter(function (f) { return f.age > 18; }))
        }
    ],
    // bulkDelete
    [
        // Delete all but one:
        function () { return db$11.friends.bulkDelete(bulkFriends.filter(function (f) { return f.age !== 20; }).map(function (f) { return f.id; })); },
        {
            friendsOver18: __spreadArrays(bulkFriends.filter(function (f) { return f.age === 20; }))
        }
    ]
]; };
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                queries = {
                    ...
                    outbound_above_z49: function () { return db$11.outbound.where('name').above("z49").toArray(); },
                    friendsOver18: function () { return db$11.friends.where('age').above(18).toArray(); }
                };
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                deepEqual$1(actualResults, expected, "" + mut.toString());
