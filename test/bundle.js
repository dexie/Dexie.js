...
QUnit.asyncTest("'unhandledrejection' should propagate once", 1, function () {
    var Promise = Dexie.Promise;
    function logErr(ev) {
...
QUnit.asyncTest("'unhandledrejection' should not propagate if catched after finally", 1, function () {
    var Promise = Dexie.Promise;
    function logErr(ev) {
...
db$7.on("populate", function (trans) {
    db$7.users.add({ id: 1, first: "David", last: "Fahlander", username: "dfahlander", email: ["david@awarica.com", "daw@thridi.com"], pets: ["dog"] });
    db$7.users.add({ id: 2, first: "Karl", last: "Cedersköld", username: "kceder", email: ["karl@ceder.what"], pets: [] });
});
