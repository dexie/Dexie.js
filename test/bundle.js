(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  QUnit.test('it should support indexable types', function () {
      ...
      QUnit.ok(cmp$1(-1, -2e3) === 1, 'Greater than numbers should return 1');
      // strings
  ...
  var isSafariPrivateMode = isSafari; // Sorry there's no way to distinguish private mode from non-private in modern Safari. Still keep it as separate variable for exposing the purpose where it's being used.
  ...
  var db$b = new Dexie("TestDBTable");
  ...
  promisedTest("Table.upsert()", function () { return __awaiter(void 0, void 0, void 0, function () {
      var existingId, wasUpdate, updatedUser, nonExistingId, wasCreate, newUser, itemWasUpdate, updatedItem, itemWasCreate, newItem, nestedId, nestedUser, newNestedId, newNestedUser;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: return [4 /*yield*/, db$b.users.add({
                      first: "Alice",
                      last: "Smith",
                      username: "asmith",
              ...
              case 1:
                  existingId = _a.sent();
                  return [4 /*yield*/, db$b.users.upsert(existingId, {
                          last: "Johnson",
                          "email.0": "alice.johnson@example.com"
                      })];
              case 2:
                  wasUpdate = _a.sent();
                  QUnit.equal(wasUpdate, true, "upsert() should return true when updating existing object");
                  return [4 /*yield*/, db$b.users.get(existingId)];
              case 3:
                  updatedUser = _a.sent();
                  QUnit.equal(updatedUser.first, "Alice", "First name should remain unchanged");
                  QUnit.equal(updatedUser.last, "Johnson", "Last name should be updated");
                  QUnit.equal(updatedUser.username, "asmith", "Username should remain unchanged");
                  QUnit.equal(updatedUser.email[0], "alice.johnson@example.com", "Email should be updated using dotted path");
                  nonExistingId = existingId + 1000;
                  return [4 /*yield*/, db$b.users.upsert(nonExistingId, {
                          first: "Bob",
                          last: "Wilson",
              ...
              case 4:
                  wasCreate = _a.sent();
                  QUnit.equal(wasCreate, false, "upsert() should return false when creating new object");
                  return [4 /*yield*/, db$b.users.get(nonExistingId)];
              case 5:
                  newUser = _a.sent();
                  QUnit.ok(newUser !== null, "New user should exist");
                  QUnit.equal(newUser.id, nonExistingId, "Primary key should be set correctly");
                  QUnit.equal(newUser.first, "Bob", "First name should be set");
                  QUnit.equal(newUser.last, "Wilson", "Last name should be set");
                  QUnit.equal(newUser.email[0], "bob@example.com", "Email should be set using dotted path");
                  QUnit.ok(newUser.username === undefined, "Username should be undefined (not specified in modifications)");
                  // Test 3: Upsert on table with outbound primary key (outbound table)
                  return [4 /*yield*/, db$b.outbound.put({ name: "Original Item" }, 100)];
              case 6:
                  // Test 3: Upsert on table with outbound primary key (outbound table)
                  _a.sent();
                  return [4 /*yield*/, db$b.outbound.upsert(100, {
                          name: "Updated Item",
                          description: "Added description"
                      })];
              case 7:
                  itemWasUpdate = _a.sent();
                  QUnit.equal(itemWasUpdate, true, "Should return true for existing item update");
                  return [4 /*yield*/, db$b.outbound.get(100)];
              case 8:
                  updatedItem = _a.sent();
                  QUnit.equal(updatedItem.name, "Updated Item", "Item name should be updated");
                  QUnit.equal(updatedItem.description, "Added description", "Description should be added");
                  return [4 /*yield*/, db$b.outbound.upsert(101, {
                          name: "New Item",
                          category: "Test"
                      })];
              case 9:
                  itemWasCreate = _a.sent();
                  QUnit.equal(itemWasCreate, false, "Should return false for new item creation");
                  return [4 /*yield*/, db$b.outbound.get(101)];
              case 10:
                  newItem = _a.sent();
                  QUnit.equal(newItem.name, "New Item", "Item name should be set");
                  QUnit.equal(newItem.category, "Test", "Category should be set");
                  QUnit.ok(newItem.id === undefined, "Primary key should not be set in object for outbound keys");
              ...
              case 11:
                  nestedId = _a.sent();
                  return [4 /*yield*/, db$b.folks.upsert(nestedId, {
                          "address.postalCode": "11122",
                          "address.country": "Sweden"
                      })];
              case 12:
                  _a.sent();
                  return [4 /*yield*/, db$b.folks.get(nestedId)];
              case 13:
                  nestedUser = _a.sent();
                  QUnit.equal(nestedUser.address.city, "Stockholm", "Existing nested property should remain");
                  QUnit.equal(nestedUser.address.street, "Kungsgatan", "Existing nested property should remain");
                  QUnit.equal(nestedUser.address.postalCode, "11122", "New nested property should be added");
                  QUnit.equal(nestedUser.address.country, "Sweden", "New nested property should be added");
                  return [4 /*yield*/, db$b.folks.count()];
              case 14:
                  newNestedId = (_a.sent()) + 1000;
                  return [4 /*yield*/, db$b.folks.upsert(newNestedId, {
                          first: "David",
              ...
              case 15:
                  _a.sent();
                  return [4 /*yield*/, db$b.folks.get(newNestedId)];
              case 16:
                  newNestedUser = _a.sent();
                  QUnit.equal(newNestedUser.first, "David", "First name should be set");
                  QUnit.equal(newNestedUser.address.city, "Göteborg", "Nested city should be set");
                  QUnit.equal(newNestedUser.address.street, "Avenyn", "Nested street should be set");
                  QUnit.ok(newNestedUser.last === undefined, "Unspecified properties should be undefined");
                  return [2 /*return*/];
          }
      });
  }); });
  ...
  spawnedTest("bulkAdd-all-results", function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  dbBulkAddAll = new Dexie("TestDBTableBulkAddAllResults");
  ...
  spawnedTest("bulkAdd-catching errors", function () {
      ...
      return __generator(this, function (_f) {
          switch (_f.label) {
              ...
              case 8:
                  _f.sent();
                  if (!!isSafariPrivateMode) return [3 /*break*/, 10];
                  _c = QUnit.equal;
                  return [4 /*yield*/, db$b.users.where('username').startsWith('xper').count()];
              case 9:
              ...
              case 13:
                  ...
                  return [3 /*break*/, 14];
              case 14:
                  if (!!isSafariPrivateMode) return [3 /*break*/, 16];
                  _d = QUnit.equal;
      ...
      return __generator(this, function (_b) {
          switch (_b.label) {
              ...
              case 1:
                  ...
                  return [4 /*yield*/, Dexie.delete("MyDatabaseToStoreCryptoKeys")];
              case 2:
                  _b.sent();
                  db = new Dexie("MyDatabaseToStoreCryptoKeys");
                  db.version(1).stores({
                      keys: "++id",
                  });
  ...
  spawnedTest("bulkPut-all-results", function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  dbBulkPutAll = new Dexie("TestDBTableBulkPutAllResults");
  ...
  promisedTest("bulkError by pos", function () { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              ...
              case 2:
                  bulkError_1 = _a.sent();
                  QUnit.ok(bulkError_1 instanceof Dexie.BulkError, "Got BulkError");
  ...
  var setupDb = function (chromeTransactionDurability) {
      var db = new Dexie("TestDBTrans", { chromeTransactionDurability: chromeTransactionDurability });
      db.version(1).stores({
          users: "username",
      });
      return db;
  ...
  var hasRequiredSortedJson;

  function requireSortedJson () {
  	if (hasRequiredSortedJson) return sortedJson;
  	hasRequiredSortedJson = 1;
  	...
  	sortedJson.sortify = sortify;
  	sortedJson.stringify = stringify;
  	return sortedJson;
  }

  var sortedJsonExports = requireSortedJson();
  var sortedJSON = /*@__PURE__*/getDefaultExportFromCjs(sortedJsonExports);
  ...
  var db$a = new Dexie("TestDBCollection");
  db$a.version(1).stores({ users: "id,first,last,[foo+bar],&username,*&email,*pets,parentPath" });
  ...
  promisedTest("Collection.modify() with replace", function () { return __awaiter(void 0, void 0, void 0, function () {
      var users;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: return [4 /*yield*/, db$a.users.bulkAdd([
              ...
              case 1:
                  _a.sent();
                  return [4 /*yield*/, db$a.users.where('parentPath').startsWith("A/B").modify({
                          parentPath: Dexie.replacePrefix("A/B", "X")
                      })];
              case 2:
                  _a.sent();
                  return [4 /*yield*/, db$a.users.where('id').between(1000, 1003).toArray()];
              case 3:
                  users = _a.sent();
                  deepEqual(users, [
                  ...
                  return [4 /*yield*/, db$a.users.where('parentPath').startsWith("X/C").modify({
                          parentPath: Dexie.replacePrefix("X/C", "Y")
                      })];
              case 4:
                  _a.sent();
                  return [4 /*yield*/, db$a.users.where('id').between(1000, 1003).toArray()];
              case 5:
                  ...
                  return [4 /*yield*/, db$a.users.toCollection().modify({
                          parentPath: Dexie.replacePrefix("X", "Z")
                      })];
              case 6:
                  _a.sent();
                  return [4 /*yield*/, db$a.users.where('id').between(1000, 1003).toArray()];
  ...
  promisedTest("Collection.modify() with add / remove", function () { return __awaiter(void 0, void 0, void 0, function () {
      var user, _a, user1, user2;
      return __generator(this, function (_b) {
          switch (_b.label) {
              case 0: return [4 /*yield*/, db$a.users.bulkAdd([
              ...
              case 1:
                  _b.sent();
                  // Mathematical add:
                  db$a.users.update(1100, {
                      age: Dexie.add(1)
                  });
                  return [4 /*yield*/, db$a.users.update(1100, {
                          age: Dexie.add(1)
                      })];
              case 2:
                  _b.sent();
                  return [4 /*yield*/, db$a.users.get(1100)];
              case 3:
                  user = _b.sent();
                  QUnit.equal(user.age, 20, "Both add operations have taken place");
                  // Money transaction
                  return [4 /*yield*/, db$a.transaction('rw', db$a.users, function () {
                          db$a.users.update(1100, { balance: Dexie.add(100) });
                          db$a.users.update(1101, { balance: Dexie.add(-100) });
                      })];
              case 4:
                  // Money transaction
                  _b.sent();
                  return [4 /*yield*/, db$a.users.bulkGet([1100, 1101])];
              case 5:
                  _a = __read.apply(void 0, [_b.sent(), 2]), user1 = _a[0], user2 = _a[1];
                  QUnit.equal(user1.balance, 200, "User 1 has 200 after transaction");
                  QUnit.equal(user2.balance, 0, "User 2 has 0 after transaction");
                  // Add to set
                  return [4 /*yield*/, db$a.users.update(1100, { pets: Dexie.add(["elephant"]) })];
              case 6:
                  // Add to set
                  _b.sent();
                  return [4 /*yield*/, db$a.users.get(1100)];
              case 7:
                  ...
                  return [4 /*yield*/, db$a.users.update(1100, { pets: Dexie.remove(["dog"]) })];
              case 8:
                  _b.sent();
                  return [4 /*yield*/, db$a.users.get(1100)];
              case 9:
                  ...
                  // Multiple operations
                  return [4 /*yield*/, db$a.users.update(1100, {
                          pets: Dexie.add(["rabbit", "cow"]),
                          age: Dexie.remove(1),
                          balance: Dexie.add(1000000)
                      })];
              case 10:
                  // Multiple operations
                  _b.sent();
              ...
              case 11:
                  ...
                  QUnit.equal(user.age, 19, "Age was decremented from 20 to 19");
                  QUnit.equal(user.balance, 1000200, "Balance was increased with a million");
                  return [2 /*return*/];
          }
      });
  }); });
  ...
  Dexie.async;
  var db$9 = new Dexie("TestDBWhereClause");
  db$9.version(2).stores({
      folders: "++id,&path",
  ...
  QUnit.asyncTest("startsWithAnyOf()", function () {
      function runTheTests(mippler) {
          ...
          return mippler(db$9.folders
              ...
              // Some specialities
              //
              return Dexie.Promise.all(mippler(db$9.folders.where('path').startsWithAnyOf([])).count(), // Empty
  ...
  QUnit.asyncTest("startsWithAnyOfIgnoreCase()", function () {
      function runTheTests(mippler) {
          ...
          return mippler(db$9.folders
              ...
              // Some specialities
              //
              return Dexie.Promise.all(mippler(db$9.folders.where('path').startsWithAnyOfIgnoreCase([])).count(), // Empty
  ...
  promisedTest("where({notIndexed: value}) should not return emtpy result", function () { return __awaiter(void 0, void 0, void 0, function () {
      var chaplin, e_1;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: return [4 /*yield*/, db$9.chaps.add({ name: "Chaplin", number: 1, age: 134, notIndexed: 'foo' })];
              case 1:
                  _a.sent();
                  _a.label = 2;
              case 2:
                  _a.trys.push([2, 4, , 5]);
                  return [4 /*yield*/, db$9.chaps.where({ name: "Chaplin", notIndexed: "foo" }).first()];
              case 3:
                  chaplin = _a.sent();
                  if (!chaplin) {
                      QUnit.ok(false, "Got empty result when data exists matching the query. If we're not using an index we should not get an empty result but an error.");
                  }
                  else {
                      QUnit.ok(chaplin, "Ok, so we got a result even though 'notIndexed' is not indexed at all. " +
                          "This is not expected but ok if the result would be valid");
                      QUnit.equal(chaplin.name, "Chaplin", "Got the correct data Chaplin!");
                  }
                  return [3 /*break*/, 5];
              case 4:
                  e_1 = _a.sent();
                  QUnit.ok(true, "Got error: \"".concat(e_1, "\" because 'notIndexed' is not indexed at all. This is also ok."));
                  return [3 /*break*/, 5];
  ...
  promisedTest("Virtual Index", function () { return __awaiter(void 0, void 0, void 0, function () {
      var davids, mambosNumber5, daves;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  if (!supports('compound'))
              ...
              case 2:
                  ...
                  return [4 /*yield*/, db$9.chaps.where({ name: "Mambo", number: 5 }).toArray()];
              case 3:
                  mambosNumber5 = _a.sent();
                  QUnit.equal(mambosNumber5.length, 1, "There should be 1 Mambo no 5 in the result");
  ...
  var db$8 = new Dexie("TestDBTrans");
          ...
          return db$8.transaction('rw', db$8.pets, function () {
              ...
              return db$8.transaction('rw', db$8.pets, function () {
                  ...
                  return Dexie.Promise.resolve().then(function () {
                      ...
                      QUnit.ok(Dexie.currentTransaction === innermostTransaction, "Still in innermost transaction");
                      return Dexie.Promise.resolve(db$8.pets.get(123));
                  }).then(function (pet) {
                      ...
                      return __generator(this, function (_a) {
                          switch (_a.label) {
                              ...
                              case 5:
                                  ...
                                  _a.sent();
                                  // Wait for function
                                  return [4 /*yield*/, Dexie.waitFor(function () { return __awaiter(void 0, void 0, void 0, function () {
                                          return __generator(this, function (_a) {
                                              switch (_a.label) {
                                                  case 0:
  ...
  promisedTest("Should be possible to open a vip DB", function () { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: return [4 /*yield*/, Dexie.delete('TestDB')];
              case 1:
                  _a.sent();
                  db = new Dexie('TestDB');
                  db.version(1).stores({ foobar: 'id' });
  ...
  promisedTest("#1842 - Should set the unique flag for primKey to true", function () { return __awaiter(void 0, void 0, void 0, function () {
      var db, primKey, fooTable, primKeyAfterCloseOpen, databases;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: 
              // First test if flag is correctly set when creating new store
              // version.ts, _parseStoresSpec()
              return [4 /*yield*/, Dexie.delete("PrimKey1842")];
              case 1:
                  // First test if flag is correctly set when creating new store
                  // version.ts, _parseStoresSpec()
                  _a.sent();
              ...
              case 2:
                  _a.sent();
                  QUnit.ok(true, "Could open new db");
                  primKey = db.foo.schema.primKey.unique;
                  QUnit.ok(primKey, "primKey should be unique");
              ...
              case 4:
                  _a.sent();
                  QUnit.ok(true, "Could open db after close");
                  return [4 /*yield*/, db.table("foo")];
              case 5:
                  fooTable = _a.sent();
                  primKeyAfterCloseOpen = fooTable.schema.primKey.unique;
                  QUnit.ok(primKeyAfterCloseOpen, "primKey should be unique after close and then open");
                  // Cleanup
                  db.close();
                  return [4 /*yield*/, Dexie.delete("PrimKey1842")];
              case 6:
                  _a.sent();
                  return [4 /*yield*/, Dexie.getDatabaseNames()];
              case 7:
                  databases = _a.sent();
                  QUnit.ok(!databases.includes("PrimKey1842"), "'PrimKey1842' should NOT be in the list of database names");
                  return [2 /*return*/];
          }
      });
  }); });

  var db$7 = new Dexie("TestYieldDb");
      ...
      return __generator(this, function (_b) {
          switch (_b.label) {
              ...
              case 2:
                  ...
                  if (!isSafariPrivateMode) return [3 /*break*/, 3];
                  QUnit.ok(true, "Safari private mode: Ignoring test due to IndexedDB bug with Safari private mode");
                  return [3 /*break*/, 5];
              case 3:
                  _a = QUnit.equal;
  ...
  */
  ...
  if (NativePromise$1) {
      ...
      if (NativePromise$1.withResolvers)
          DexiePromise.withResolvers = NativePromise$1.withResolvers;
  }
  /**
  ...
  */
  ...
  var db$6 = new Dexie("TestDBTranx");
  ...
  QUnit.test("Should be able to use native async await", function (assert) {
      ...
      Dexie.Promise.resolve(idbAndPromiseCompatible).then(function () {
          ...
          return f(QUnit.ok, QUnit.equal, Dexie, db$6);
          ...
          return __generator(this, function (_a) {
              switch (_a.label) {
                  ...
                  case 1:
                      ...
                      F(QUnit.ok, QUnit.equal, Dexie, db$6).catch(function (e) { return QUnit.ok(false, e.stack || e); }).then(done);
                      return [2 /*return*/];
              }
          });
      });
          ...
          return __generator(this, function (_a) {
              ...
              db$6.transaction('rw', db$6.items, function () {
                  ...
                  return db$6.items.get(1).then(function () {
                      ...
                      return f(QUnit.ok, QUnit.equal, Dexie, trans, NativePromise, db$6);
                  }).catch(function (e) {
  ...
  var db$5 = new Dexie("TestDBException");
  ...
  promisedTest("PR #959: Dexie should no more require users to keep old versions if they don't attach an upgrader to it", function () { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  DBNAME = "pr959";
                  return [4 /*yield*/, Dexie.delete(DBNAME)];
              case 1:
                  _a.sent();
                  db = new Dexie(DBNAME);
                  db.version(1).stores({
  ...
  promisedTest("Issue #959 - Should migrate successfully with an explicit unique modifier of the primary key", function () { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: return [4 /*yield*/, Dexie.delete("issue959")];
              case 1:
                  _a.sent();
  ...
  promisedTest("Dexie 4: Should not throw VersionError on downgrade", function () { return __awaiter(void 0, void 0, void 0, function () {
      var DBNAME, db, friends;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  DBNAME = "downgradedDB";
              ...
              case 1:
                  ...
                  return [4 /*yield*/, db.friends.get(undefined).catch(function (e) { })];
              case 2:
                  _a.sent();
                  return [4 /*yield*/, db.open()];
              case 3:
                  _a.sent();
                  QUnit.ok(true, "Could open v2");
                  return [4 /*yield*/, db.friends.add({ id: 1, name: "Foo 959" })];
              case 4:
                  _a.sent();
                  db.close();
              ...
              case 5:
                  _a.sent();
                  QUnit.ok(true, "Could open v1 even though installed version is at verion 2.");
                  return [4 /*yield*/, db.friends.toArray()];
              case 6:
                  friends = _a.sent();
                  QUnit.equal(friends.length, 1, "Could use the database for querying");
                  return [4 /*yield*/, db.delete()];
              case 7:
                  _a.sent();
                  return [2 /*return*/];
  ...
  promisedTest("Dexie 4: It should add indexes and tables also when not incrementing version number", function () { return __awaiter(void 0, void 0, void 0, function () {
      var DBNAME, db, pets, friends;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  DBNAME = "forgettingVerNoIncrease";
                  return [4 /*yield*/, Dexie.delete(DBNAME)];
              case 1:
                  _a.sent();
                  db = new Dexie(DBNAME);
              ...
              case 2:
                  _a.sent();
                  QUnit.ok(true, "Could open v1 with {friends: 'id'}");
                  return [4 /*yield*/, db.friends.add({ id: 1, name: "Foo 123" })];
              case 3:
                  _a.sent();
                  db.close();
                  db = new Dexie(DBNAME);
              ...
              case 4:
                  _a.sent();
                  QUnit.ok(true, "Could open v1 even though we have added some indexes and a table.");
                  return [4 /*yield*/, db.friends.add({ id: 2, name: "Bar 123", age: 25 })];
              case 5:
                  _a.sent();
                  return [4 /*yield*/, db.pets.add({ id: 1, friendId: 2, kind: "dog" })];
              case 6:
                  _a.sent();
                  QUnit.ok(true, "Could add pets to the new table");
                  return [4 /*yield*/, db.pets.toArray()];
              case 7:
                  pets = _a.sent();
                  return [4 /*yield*/, db.friends.toArray()];
              case 8:
                  friends = _a.sent();
                  QUnit.equal(friends.length, 2, "Got the two friends");
                  QUnit.equal(pets.length, 1, "Got the one pet");
                  db.close();
                  return [2 /*return*/];
          }
      });
  }); });
  promisedTest("Dexie 4: It should work having two versions of the DB opened at the same time as long as they have a compatible schema", function () { return __awaiter(void 0, void 0, void 0, function () {
      var DBNAME, db1, db2, foo, db;
      var _a;
      return __generator(this, function (_b) {
          switch (_b.label) {
              case 0:
                  if (typeof ((_a = Dexie.Observable) === null || _a === void 0 ? void 0 : _a.version) === 'string') {
                      QUnit.ok(true, "Skipping this test - Dexie.Observable bails out when opening two versions of the same database");
                      return [2 /*return*/];
                  }
                  DBNAME = "competingDBs";
                  return [4 /*yield*/, Dexie.delete(DBNAME)];
              case 1:
                  _b.sent();
                  db1 = new Dexie(DBNAME);
                  db1.version(1).stores({
                      friends: "id"
                  });
                  db2 = new Dexie(DBNAME);
                  db2.version(2).stores({
                      friends: "id, name, age",
                      pets: 'id, friendId, kind'
                  });
                  return [4 /*yield*/, Promise$2.all(db1.open(), db2.open())];
              case 2:
                  _b.sent();
                  return [4 /*yield*/, db1.friends.add({ id: 1, name: "Foo 123" })];
              case 3:
                  _b.sent();
                  return [4 /*yield*/, db2.friends.where('name').startsWith('Foo').first()];
              case 4:
                  foo = _b.sent();
                  QUnit.ok(true, "We could use the 'name' index only declared on db2");
                  foo.age = 23;
                  return [4 /*yield*/, db2.friends.put(foo)];
              case 5:
                  _b.sent();
                  return [4 /*yield*/, db1.friends.get(1)];
              case 6:
                  foo = _b.sent();
                  QUnit.equal(foo.age, 23, "We could get the data using db1");
                  db1.close();
                  db2.close();
                  return [4 /*yield*/, db1.open()];
              case 7:
              ...
              case 10:
                  _b.sent();
                  return [4 /*yield*/, db1.friends.where('[name+age]').equals(["Foo 123", 23]).first()];
              case 11:
                  foo = _b.sent(); // Should be able to use the new index
                  QUnit.equal(foo.age, 23, "We could get the data using db1 and the added index 'name+age' still in v1");
                  return [4 /*yield*/, db2.friends.get({ age: 23 })];
              case 12:
                  foo = _b.sent(); // Be able to use the age index that db2 declares.
                  QUnit.equal(foo.age, 23, "We could get the data using db2 and the 'name' index");
                  return [4 /*yield*/, new Dexie(DBNAME).open()];
              case 13:
                  db = _b.sent();
                  QUnit.ok(db.verno < 3, "The database should be at version 2 (or exactly: " + db.verno + ")");
                  return [4 /*yield*/, Dexie.delete(DBNAME)];
              case 14:
                  _b.sent();
                  return [2 /*return*/];
  ...
  promisedTest("Dexie 4: An attached upgrader on version 2 and 3 shall run even if version 1 was reused for schema manipulation more than 20 times", function () { return __awaiter(void 0, void 0, void 0, function () {
      var DBNAME, NUM_SCHEMA_CHANGES, db, i, objFromUpgrader, objFromUpgrader3;
      var _a;
      var _b;
      return __generator(this, function (_c) {
          switch (_c.label) {
              case 0:
                  if (typeof ((_b = Dexie.Observable) === null || _b === void 0 ? void 0 : _b.version) === 'string') {
                      QUnit.ok(true, "Skipping this test - Dexie.Observable bails out when database reopen in background");
                      return [2 /*return*/];
                  }
                  DBNAME = "attachedUpgrader";
                  NUM_SCHEMA_CHANGES = 31;
                  return [4 /*yield*/, Dexie.delete(DBNAME)];
              case 1:
                  _c.sent();
                  db = new Dexie(DBNAME);
                  ...
                  _c.label = 2;
              case 2:
                  if (!(i <= NUM_SCHEMA_CHANGES)) return [3 /*break*/, 5];
              ...
              case 4:
                  ...
                  return [3 /*break*/, 2];
              case 5:
                  QUnit.ok(true, "Could change schema a ".concat(NUM_SCHEMA_CHANGES, " times while still being on version 1, without error"));
                  return [4 /*yield*/, db.open()];
              case 6:
                  _c.sent();
                  QUnit.equal(db.verno, 1, "The database should be at version 1");
                  return [4 /*yield*/, db.table("table1").add({ id: 1, name: "Foo 123" })];
              case 7:
                  _c.sent();
                  QUnit.ok(true, "Could add things to table1");
                  return [4 /*yield*/, db.table("table" + NUM_SCHEMA_CHANGES).add({ id: 1, name: "Foo 123" })];
              case 8:
                  _c.sent();
                  QUnit.ok(true, "Could add things to table".concat(NUM_SCHEMA_CHANGES));
                  db.close();
                  db = new Dexie(DBNAME);
                  db.version(2).stores({
                      version2Table: "id",
                      ...
                      return __generator(this, function (_a) {
                          switch (_a.label) {
                              case 0: return [4 /*yield*/, tx.version2Table.add({ id: 1, foo: "bar" })];
                              case 1:
                                  _a.sent();
                                  return [2 /*return*/];
                          }
              ...
              case 9:
                  _c.sent();
                  QUnit.ok(true, "Could open v2");
                  return [4 /*yield*/, db.version2Table.get(1)];
              case 10:
                  objFromUpgrader = _c.sent();
                  QUnit.ok(!!objFromUpgrader, "The upgrader of version 2 have run");
                  db.close();
                  db.version(3).stores({
                      version3Table: "id",
                  }).upgrade(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                      return __generator(this, function (_a) {
                          switch (_a.label) {
                              case 0: return [4 /*yield*/, tx.version3Table.add({ id: 1, foo: "bar" })];
                              case 1:
                                  _a.sent();
                                  return [2 /*return*/];
                          }
                  ...
                  return [4 /*yield*/, db.open().catch(function (err) {
                          QUnit.ok(false, "Failed to upgrade to version 3: " + err); // Would fail here if version 2 was rerun a second time (ConstraintError)
                          throw err;
                      })];
              case 11:
                  _c.sent();
                  QUnit.ok(true, "Could open v3");
                  return [4 /*yield*/, db.version3Table.get(1)];
              case 12:
                  objFromUpgrader3 = _c.sent();
                  QUnit.ok(!!objFromUpgrader3, "The upgrader of version 3 have run");
                  return [4 /*yield*/, Dexie.delete(DBNAME)];
              case 13:
                  _c.sent();
                  return [2 /*return*/];
  ...
  var db$4 = new Dexie("TestIssuesDB");
          ...
          switch (_b.label) {
              case 0:
                  if (typeof BigInt64Array === 'undefined') {
                      QUnit.ok(true, "BigInt64Array not supported in browser");
                      return [2 /*return*/];
                  }
                  if (typeof ((_a = Dexie.Observable) === null || _a === void 0 ? void 0 : _a.version) === 'string') {
                      QUnit.ok(true, "Skipping this test - Dexie.Observable bails out from BigInts");
                      return [2 /*return*/];
                  }
                  return [4 /*yield*/, db$4.foo.put({
                          id: 1,
                          updated: Date.now(),
                          cols: [{
              ...
              case 2:
                  val = _b.sent();
                  QUnit.ok(val.cols[0].values instanceof BigInt64Array, "cols[0].values is a BigInt64Array");
                  return [4 /*yield*/, db$4.foo.update(1, {
                          updated: Date.now()
                      })];
              case 3:
                  _b.sent();
              ...
              case 4:
                  val = _b.sent();
                  QUnit.ok(val.cols[0].values instanceof BigInt64Array, "cols[0].values is still a BigInt64Array after update");
                  return [2 /*return*/];
          }
      });
  }); });
  ...
  var Promise$1 = Dexie.Promise, all = Promise$1.all, async = Dexie.async; Dexie.spawn;
  var db$3 = new Dexie("TestDBCrudHooks");
  ...
  var db$2 = new Dexie("TestDBBinary");
          ...
          switch (_a.label) {
              case 0:
                  if (isSafariPrivateMode) {
                      QUnit.ok(true, "Safari private mode does not support Blobs");
                      return [2 /*return*/];
                  }
  ...
  var db$1 = new Dexie("TestDBBinaryKeys");
  ...
  var db = new Dexie("TestLiveQuery", {
  ...
  function liveQueryUnitTester(lq, _a) {
      var _b = _a === void 0 ? { graceTime: 0 } : _a; _b.graceTime;
      var lq = Dexie.liveQuery(lq);
      return {
          waitTilDeepEqual: function (expected, description, timeout) {
              if (timeout === void 0) { timeout = 500; }
              return new Promise(function (resolve, reject) {
                  var latestValue;
                  var subscription = lq.subscribe(function (value) {
                      latestValue = value;
  ...
  promisedTest("subscribe to range", function () { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  tester = liveQueryUnitTester(function () { return db.items.toArray(); });
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: 1 }, { id: 2 }, { id: 3 }], "First callback should give initally populated content")];
              case 1:
                  _a.sent();
                  db.items.add({ id: -1 });
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: -1 }, { id: 1 }, { id: 2 }, { id: 3 }], "2nd callback should give updated content")];
              case 2:
                  _a.sent();
                  db.items.delete(2);
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: -1 }, { id: 1 }, { id: 3 }], "3rd callback should wake up when deletion was made")];
              case 3:
                  _a.sent();
                  return [2 /*return*/];
          }
  ...
  promisedTest("optimistic updates that eventually fail must be reverted (Issue #1823)", function () { return __awaiter(void 0, void 0, void 0, function () {
      var log, subscription;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  log = [];
                  subscription = Dexie.liveQuery(function () { return db.items.toArray(); }).subscribe({
                      next: function (result) {
                          log.push(result);
                          console.log("optimistic result (from #1823 test)", result);
                      },
                  });
                  return [4 /*yield*/, db.transaction('rw', db.items, function () { return __awaiter(void 0, void 0, void 0, function () {
                          return __generator(this, function (_a) {
                              switch (_a.label) {
                                  case 0: 
                                  // Simple test a catched failing operation
                                  return [4 /*yield*/, db.items.add({ id: 1, iWillFail: true } // Contraint error (key 1 already exists)
                                      ).catch(function () { })];
                                  case 1:
                                      // Simple test a catched failing operation
                                      _a.sent();
                                      // Test another code path in adjustOptimisticFromFailures() where some operations succeed and some not.
                                      return [4 /*yield*/, db.items.bulkAdd([
              ...
              case 1:
                  ...
                  return [4 /*yield*/, db.transaction('r', db.items, function () { return db.items.toArray(); })];
              case 2:
                  // Wait for a successful readonly transaction to complete after the write transaction.
                  // This will make sure that the liveQuery has been updated with the final result.
                  _a.sent();
  ...
  var mutsAndExpects = function () { return [
      ...
      [
          function () { return db.issue1946.add({ name: "A", age: 20 }); },
          {
      ...
      [
          function () { return db.issue1946.bulkAdd([
              { name: "A", age: 19 },
      ...
      // Issue 2011 / 2012
      [
          function () { return db.items.bulkPut([
              { id: 6, name: "One" },
              { id: 6, name: "Two" },
              { id: 6, name: "Three" }
          ]); },
          ...
          switch (_e.label) {
              case 0:
                  queries = {
                      ...
                      multiEntry3: function () { return db.multiEntry.where({ tags: "x" }).toArray(); },
                      // Issue https://github.com/dexie/Dexie.js/issues/1946
                      compoundOrderBy: function () { return db.issue1946.orderBy('[name+age]').toArray(); },
                      compoundOrderByWithAutoIncKey: function () { return db.issue1946.orderBy('[name+age+id]').toArray(); },
                  };
                  ...
                  subscriptions = Object.keys(queries).map(function (name) {
                      var gotAnyData = false;
                      ++flyingNow;
                      var subscription = observables.get(name).subscribe({
                          next: function (res) {
                              if (!gotAnyData) {
                                  gotAnyData = true;
                                  if (--flyingNow === 0)
              ...
              case 2:
                  ...
                  prevActual_1 = Dexie.deepClone(actualResults);
                      ...
                      return __generator(this, function (_g) {
                          switch (_g.label) {
                              ...
                              case 4:
                                  ...
                                  return [3 /*break*/, 5];
                              case 5:
                                  expected = Dexie.deepClone(expects);
                                  if (allowedExtra)
                                      Array.isArray(allowedExtra) ? allowedExtra.forEach(function (key) {
  ...
  promisedTest("Isolation: Explicit rw transactions do not affect live queries before committed", function () { return __awaiter(void 0, void 0, void 0, function () {
      var log, signal, subscription, result;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  log = [];
                  ...
                  subscription = Dexie.liveQuery(function () { return db.items.toArray(); }).subscribe(function (result) {
                      log.push({ type: "emit", result: result });
              ...
              case 1:
                  ...
                  return [4 /*yield*/, db.transaction('rw', db.items, function () { return __awaiter(void 0, void 0, void 0, function () {
                          return __generator(this, function (_a) {
                              switch (_a.label) {
                                  case 0: return [4 /*yield*/, db.items.add({ id: 4 })];
                                  case 1:
                                      _a.sent();
                                      return [4 /*yield*/, db.items.update(4, { name: "A" })];
                                  case 2:
                                      _a.sent();
                                      return [4 /*yield*/, db.items.toArray()];
                                  case 3:
                                      _a.sent(); // Make some additional work in the transaction
                                      return [4 /*yield*/, db.items.count()];
                                  case 4:
                                      _a.sent(); // Make some additional work in the transaction
                                      QUnit.equal(log.length, 1, "No new emit should have been made yet");
                                      return [2 /*return*/];
                              }
                          });
                      }); })];
              ...
              case 3:
                  ...
                  //signal = new Signal();
                  return [4 /*yield*/, db.transaction('rw', db.items, function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                          return __generator(this, function (_a) {
                              switch (_a.label) {
                                  case 0: return [4 /*yield*/, db.items.add({ id: 5 })];
                                  case 1:
                                      _a.sent();
                                      QUnit.equal(log.length, 2, "No new emit should have been made");
  ...
  promisedTest("Issue 1821: liveQuery containing primaryKeys should not emit when content on one element is changed", function () { return __awaiter(void 0, void 0, void 0, function () {
      var log, signal, subscription, result;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  log = [];
                  signal = new Signal();
                  subscription = Dexie.liveQuery(function () { return db.items.orderBy('id').primaryKeys(); }).subscribe(function (result) {
                      log.push({ type: "emit", result: result });
                      signal.resolve(result);
                  });
                  return [4 /*yield*/, signal.promise];
              case 1:
                  ...
                  return [4 /*yield*/, db.items.update(1, { name: "A" })];
              case 2:
                  _a.sent(); // This should not emit anything since the primary key is not changed.
                  QUnit.equal(log.length, 1, "No new emit should have been made");
                  return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 25); })];
              case 3:
                  _a.sent();
                  signal = new Signal();
                  return [4 /*yield*/, db.items.add({ id: 4 })];
              case 4:
                  _a.sent(); // This should emit though.
                  return [4 /*yield*/, signal.promise];
              case 5:
                  _a.sent();
                  QUnit.equal(log.length, 2, "Only one extra emit should have been made");
                  deepEqual(log, [
  ...
  promisedTest("Issue 2067: useLiveQuery does not update when multiple items are deleted", function () { return __awaiter(void 0, void 0, void 0, function () {
      var items, tester;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0: return [4 /*yield*/, db.items.reverse().toArray()];
              case 1:
                  items = _a.sent();
                  deepEqual(items, [{ id: 3 }, { id: 2 }, { id: 1 }], "Initial items are correct");
                  tester = liveQueryUnitTester(function () { return db.items.reverse().toArray(); });
                  db.items.where('id').above(0).delete();
                  return [4 /*yield*/, tester.waitTilDeepEqual([], "Items are deleted")];
              case 2:
                  _a.sent();
                  db.items.bulkAdd([{ id: -10 }, { id: 0 }, { id: 10 }]);
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: 10 }, { id: 0 }, { id: -10 }], "Reacts on bulkAdd")];
              case 3:
                  _a.sent();
                  db.items.where('id').above(0).delete();
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: 0 }, { id: -10 }], "Should have deleted items where id > 0")];
              case 4:
                  _a.sent();
                  return [2 /*return*/];
          }
  ...
  promisedTest("Issue 2058 - related but with bulkAdd and constraint error on duplicate primary keys.", function () { return __awaiter(void 0, void 0, void 0, function () {
      var tester, itemsToAdd;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  tester = liveQueryUnitTester(function () { return db.items.toArray(); }, { graceTime: 100 });
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: 1 }, { id: 2 }, { id: 3 }], "Initial items are correct")];
              case 1:
                  _a.sent();
                  return [4 /*yield*/, db.items.bulkAdd([
                          ...
                          QUnit.equal(error.failuresByPos[0].name, "ConstraintError", "Expected constraint error for the first operation");
                      })];
              case 2:
                  _a.sent();
                  return [4 /*yield*/, tester.waitTilDeepEqual([{ id: 1 }, { id: 2 }, { id: 3 }, { id: 88 }], "The livequery emitted correct result after bulk operation")];
              case 3:
                  _a.sent();
                  itemsToAdd = new Array(51)
                  ...
                  ;
                  return [4 /*yield*/, db.items.bulkAdd(itemsToAdd).catch(function (error) {
              ...
              case 4:
                  ...
                  return [4 /*yield*/, tester.waitTilDeepEqual([
                          { id: 1 },
                          { id: 2 },
                          { id: 3 },
                          { id: 88 },
  ...
  promisedTest("Issue 2058: Cache error after bulkPut failures", function () { return __awaiter(void 0, void 0, void 0, function () {
      var tester;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  tester = liveQueryUnitTester(function () { return db.issue2058.toArray(); }, { graceTime: 10 });
                  return [4 /*yield*/, db.issue2058.bulkAdd([
                          { id: "1.1", a: 1, b: 1 },
                          { id: "1.2", a: 1, b: 2 },
                          { id: "2.1", a: 2, b: 1 },
                      ])];
              ...
              case 2:
                  _a.sent();
                  return [4 /*yield*/, db.issue2058.bulkPut([
                          { id: "2.2", a: 2, b: 2 },
                          { id: "foo", a: 1, b: 1 }
                      ]).catch(function (error) {
                          QUnit.equal(error.failuresByPos[1].name, "ConstraintError", "Expected constraint error for the first operation");
                      })];
              case 3:
                  _a.sent();
                  return [4 /*yield*/, tester.waitTilDeepEqual([
  ...
  QUnit.module("IndexedDB 3.0 features", {
      setup: function () {
          QUnit.stop();
          Dexie.delete("TestDB-idb30").then(QUnit.start);
      },
      teardown: function () {
          QUnit.stop();
          Dexie.delete("TestDB-idb30").then(QUnit.start);
  ...
  spawnedTest("reverse toArray() should work correctly", function () {
      var db, forward, reverse;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  db = new Dexie("TestDB-idb30");
                  db.version(1).stores({
                      items: '++id, name'
                  });
                  return [4 /*yield*/, db.open()];
              ...
              case 3:
                  forward = _a.sent();
                  QUnit.equal(forward.length, 5, "Forward toArray returns 5 items");
                  QUnit.equal(forward[0].name, 'Alice', "First item is Alice");
                  QUnit.equal(forward[4].name, 'Eve', "Last item is Eve");
                  return [4 /*yield*/, db.items.reverse().toArray()];
              case 4:
                  reverse = _a.sent();
                  QUnit.equal(reverse.length, 5, "Reverse toArray returns 5 items");
                  QUnit.equal(reverse[0].name, 'Eve', "First item in reverse is Eve");
                  QUnit.equal(reverse[4].name, 'Alice', "Last item in reverse is Alice");
                  db.close();
                  return [2 /*return*/];
          }
      });
  ...
  spawnedTest("reverse primaryKeys() should work correctly", function () {
      var db, ids, forwardKeys, reverseKeys;
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  db = new Dexie("TestDB-idb30");
              ...
              case 2:
                  ids = _a.sent();
                  return [4 /*yield*/, db.items.toCollection().primaryKeys()];
              case 3:
                  forwardKeys = _a.sent();
                  QUnit.deepEqual(forwardKeys, ids, "Forward primaryKeys returns correct order");
                  return [4 /*yield*/, db.items.reverse().primaryKeys()];
              case 4:
                  reverseKeys = _a.sent();
                  QUnit.deepEqual(reverseKeys, __spreadArray([], __read(ids), false).reverse(), "Reverse primaryKeys returns reversed order");
                  db.close();
                  return [2 /*return*/];
          }
      });
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              ...
              case 2:
                  ...
                  return [4 /*yield*/, db.items.add({ value: i })];
              case 3:
                  _a.sent();
                  _a.label = 4;
              case 4:
                  i++;
                  return [3 /*break*/, 2];
              case 5: return [4 /*yield*/, db.items.reverse().limit(3).toArray()];
              case 6:
                  result = _a.sent();
                  QUnit.equal(result.length, 3, "Limit works with reverse");
                  QUnit.equal(result[0].value, 10, "First item is 10 (highest)");
                  QUnit.equal(result[1].value, 9, "Second item is 9");
                  QUnit.equal(result[2].value, 8, "Third item is 8");
                  db.close();
                  return [2 /*return*/];
          }
      });
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              ...
              case 2:
                  // Add test data
                  _a.sent();
                  return [4 /*yield*/, db.items.orderBy('name').toArray()];
              case 3:
                  forward = _a.sent();
                  QUnit.equal(forward[0].name, 'Alice', "Forward orderBy: first is Alice");
                  QUnit.equal(forward[2].name, 'Charlie', "Forward orderBy: last is Charlie");
                  return [4 /*yield*/, db.items.orderBy('name').reverse().toArray()];
              case 4:
                  reverse = _a.sent();
                  QUnit.equal(reverse[0].name, 'Charlie', "Reverse orderBy: first is Charlie");
                  QUnit.equal(reverse[2].name, 'Alice', "Reverse orderBy: last is Alice");
                  db.close();
                  return [2 /*return*/];
          }
      });
  ...
  QUnit.module("maxConnections", {
      setup: function () {
          var e_1, _a;
          try {
              // Close all connections left open by previous tests to ensure they don't affect the results of these tests.
              for (var _b = __values(__spreadArray([], __read(Dexie.connections), false)), _c = _b.next(); !_c.done; _c = _b.next()) {
          ...
          QUnit.equal(Dexie.connections.length, 0, "No connections initially");
      },
      teardown: function () {
          return __generator(this, function (_a) {
              switch (_a.label) {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              ...
              case 1:
                  ...
                  QUnit.equal(dbs.length, 0, "No connections initially");
                  i = 0;
                  _a.label = 2;
              case 2:
                  if (!(i < max)) return [3 /*break*/, 5];
                  db = new Dexie("TestDB", { maxConnections: max });
                  db.version(1).stores({ foo: 'id' });
                  return [4 /*yield*/, db.open()];
              case 3:
                  _a.sent();
              ...
              case 4:
                  ...
                  return [3 /*break*/, 2];
              case 5:
                  QUnit.equal(Dexie.connections.length, max, "Should have reached max connections");
                  extraDb = new Dexie("TestDB", { maxConnections: max });
                  extraDb.version(1).stores({ foo: 'id' });
                  _a.label = 6;
              case 6:
                  _a.trys.push([6, 8, 9, 11]);
                  return [4 /*yield*/, extraDb.open()];
              case 7:
                  _a.sent();
                  QUnit.equal(Dexie.connections.length, max, "Should not have exceeded max connections");
                  return [3 /*break*/, 11];
              case 8:
                  e_2 = _a.sent();
                  QUnit.equal(e_2.name, "MaxConnectionsReachedError", "Could throw MaxConnectionsReachedError: " + e_2.message);
                  return [3 /*break*/, 11];
              case 9: return [4 /*yield*/, extraDb.close()];
              case 10:
                  _a.sent();
                  return [7 /*endfinally*/];
              case 11: 
              // Close one and try again
              return [4 /*yield*/, dbs[0].close()];
              case 12:
                  // Close one and try again
                  _a.sent();
                  QUnit.equal(Dexie.connections.length, max - 1, "Should have one less connection");
                  return [4 /*yield*/, dbs[0].open()];
              case 13:
                  _a.sent();
                  QUnit.equal(Dexie.connections.length, max, "Should have reached max connections again");
                  return [3 /*break*/, 16];
              case 14: return [4 /*yield*/, Promise.all(dbs.map(function (db) { return db.close(); }))];
              case 15:
                  _a.sent();
                  return [7 /*endfinally*/];
          ...
          switch (_a.label) {
              case 0:
                  if (typeof FinalizationRegistry === 'undefined') {
                      QUnit.ok(true, "FinalizationRegistry not supported in this environment");
                      return [2 /*return*/];
                  }
                  max = 20;
                  dbs = [];
              ...
              case 1:
                  _a.trys.push([1, , 6, 8]);
                  QUnit.equal(Dexie.connections.length, 0, "No tracked connections initially");
                  i = 0;
                  _a.label = 2;
              case 2:
              ...
              case 4:
                  ...
                  return [3 /*break*/, 2];
              case 5:
                  QUnit.equal(Dexie.connections.length, 5, "Connections should be tracked");
                  return [3 /*break*/, 8];
              case 6: return [4 /*yield*/, Promise.all(dbs.map(function (db) { return db.close(); }))];
              case 7:
                  _a.sent();
                  return [7 /*endfinally*/];
              case 8:
                  QUnit.equal(Dexie.connections.length, 0, "Connections should not be tracked after explicit close");
                  return [2 /*return*/];
          }
      });
  });
