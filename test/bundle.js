(function (global, factory) {
    ...
    ***************************************************************************** */
      ...
      */
        ...
        try {
            for (var viewTypes_1 = __values(viewTypes), viewTypes_1_1 = viewTypes_1.next(); !viewTypes_1_1.done; viewTypes_1_1 = viewTypes_1.next()) {
                ...
                QUnit.ok(cmp$1(v1, v2) === 0, "Equal " + typeName + "s should return 0");
                // Less than
                v1 = new ArrayBufferView(zeroes1);
                v2 = new ArrayBufferView(ones);
                QUnit.ok(cmp$1(v1, v2) === -1, "Less than " + typeName + "s should return -1");
                // Less than
                v1 = new ArrayBufferView(ones);
                v2 = new ArrayBufferView(zeroes1);
                QUnit.ok(cmp$1(v1, v2) === 1, "Greater than " + typeName + "s should return 1");
            }
        }
    ...
    QUnit.test('it should treat different binary types as if they were equal', function () {
        ...
        try {
            for (var viewTypes_2 = __values(viewTypes), viewTypes_2_1 = viewTypes_2.next(); !viewTypes_2_1.done; viewTypes_2_1 = viewTypes_2.next()) {
                ...
                var v1 = new ArrayBufferView(zeroes1);
                QUnit.ok(cmp$1(v1, zeroes1) === 0, "Comparing " + typeName + " with ArrayBuffer should return 0 if they have identical data");
            }
        }
    ...
    function deepEqual$1(a, b, description) {
    ...
    promisedTest("where({notIndexed: value}) should not return emtpy result", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    e_1 = _a.sent();
                    QUnit.ok(true, "Got error: \"" + e_1 + "\" because 'notIndexed' is not indexed at all. This is also ok.");
                    return [3 /*break*/, 5];
    ...
    intrinsicTypeNames.map(function (t) { return _global[t]; });
    ...
    */
    ...
    function DexiePromise(fn) {
        ...
        this._listeners = [];
        this.onuncatched = nop$1; // Deprecate in next major. Not needed. Better to use global error handler.
    ...
    */
    ...
    QUnit.asyncTest("Issue #69 Global exception handler for promises", function () {
        ...
        new Dexie__default["default"].Promise(function () {
        ...
        Dexie__default["default"].Promise.resolve(Promise.reject(new Error("Converting a rejected standard promise to Dexie.Promise but don't catch it")))
            .finally(function () {
    ...
    promisedTest("Issue #1333 - uniqueKeys on virtual index should produce unique results", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    result = _a.sent();
                    QUnit.ok(result.length === 2, "Unexpected array length " + result.length + " from uniqueKeys on virtual index, expected 2. Got " + result.join(','));
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    QUnit.asyncTest("unhandledrejection2", function () {
        ...
        window.addEventListener('unhandledrejection', onError);
        new Dexie__default["default"].Promise(function (resolve, reject) {
            new Dexie__default["default"].Promise(function (resolve2, reject2) {
                reject2("error");
    ...
    ***************************************************************************** */
    ...
    promisedTest("Full use case matrix", function () { return __awaiter(void 0, void 0, void 0, function () {
        var queries, expectedInitialResults, flyingNow, signal, actualResults, observables, subscriptions, prevActual_1, _loop_1, _a, _b, _c, mut, expects, allowedExtra, e_1_1;
        var e_1, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
