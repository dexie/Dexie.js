...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.Dexie = global.Dexie || {}, global.Dexie.Observable = factory(global.Dexie)));
    ...
    function initCreatingHook(db, table) {
        return function creatingHook(primKey, obj, trans) {
            ...
            if (primKey === undefined && table.schema.primKey.uuid) {
                primKey = rv = Dexie__default["default"].Observable.createUUID();
                if (table.schema.primKey.keyPath) {
                    Dexie__default["default"].setByKeyPath(obj, table.schema.primKey.keyPath, primKey);
                }
            }
            var change = {
        ...
        db.observable.sendMessage = function (type, message, destinationNode, options) {
            ...
            if (!mySyncNode.node)
                return options.wantReply ?
                    Promise$2.reject(new Dexie__default["default"].DatabaseClosedError()) :
            ...
            Dexie__default["default"].extend(msg, options); // wantReply: wantReply, success: !isFailure, requestId: ...
    ...
    /** class DatabaseChange
        ...
        */
    var DatabaseChange = Dexie__default["default"].defineClass({
        rev: Number,
        source: String,
        table: String,
        key: Object,
    ...
    var override = Dexie__default["default"].override;
    var Promise$1 = Dexie__default["default"].Promise;
    ...
    function Observable(db) {
        ...
        if (db.observable) {
            if (db.observable.version !== "4.0.1-beta.13")
        ...
        /** class SyncNode
            ...
            */
        var SyncNode = Dexie__default["default"].defineClass({
            //id: Number,
            myRevision: Number,
            type: String,
        ...
        db.observable = { version: "4.0.1-beta.13" };
        ...
        if (Dexie__default["default"].fake) {
        ...
        db.on("ready", function startObserving() {
            ...
            return db.table("_changes").orderBy("rev").last(function (lastChange) {
                ...
                return db._syncNodes.put(mySyncNode.node).then(Dexie__default["default"].ignoreTransaction(function () {
        ...
        function readChanges(latestRevision, recursion, wasPartial) {
            ...
            if (!ourSyncNode) {
                return Promise$1.reject(new Dexie__default["default"].DatabaseClosedError());
            }
            var LIMIT = 1000;
    ...
    // 
    Observable.version = "4.0.1-beta.13";
    Observable.latestRevision = {}; // Latest revision PER DATABASE. Example: Observable.latestRevision.FriendsDB = 37;
    Observable.on = Dexie__default["default"].Events(null, "latestRevisionIncremented", "suicideNurseCall", "intercomm", "beforeunload"); // fire(dbname, value);
    ...
    //
    if (global === null || global === void 0 ? void 0 : global.addEventListener) {
    ...
    if (Dexie__default["default"].Observable) {
        if (Dexie__default["default"].Observable.version !== "4.0.1-beta.13") {
            throw new Error("Mixed versions of dexie-observable");
        }
    }
    else {
        // Register addon:
        Dexie__default["default"].Observable = Observable;
        Dexie__default["default"].addons.push(Observable);
    }
    var Dexie_Observable = Dexie__default["default"].Observable;

    return Dexie_Observable;
