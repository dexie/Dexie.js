...
(function (global, factory) {
    ...
    function Observable(db) {
        ...
        if (db.observable) {
            if (db.observable.version !== "3.0.0-beta.10")
        ...
        db.observable = { version: "3.0.0-beta.10" };
    ...
    // 
    Observable.version = "3.0.0-beta.10";
    ...
    if (Dexie__default['default'].Observable) {
        if (Dexie__default['default'].Observable.version !== "3.0.0-beta.10") {
            throw new Error("Mixed versions of dexie-observable");
        }
    }
    else {
