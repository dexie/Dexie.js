 ...
 * ==========================================================================
 *
 * Version 3.0.0-beta.11, Sun Dec 19 2021
 *
 * https://dexie.org
 *
...
(function (global, factory) {
    ...
    function Observable(db) {
        ...
        if (db.observable) {
            if (db.observable.version !== "3.0.0-beta.11")
        ...
        db.observable = { version: "3.0.0-beta.11" };
    ...
    // 
    Observable.version = "3.0.0-beta.11";
    ...
    if (Dexie__default["default"].Observable) {
        if (Dexie__default["default"].Observable.version !== "3.0.0-beta.11") {
            throw new Error("Mixed versions of dexie-observable");
        }
    }
    else {
