...
(function (global, factory) {
    ...
    function Observable(db) {
        ...
        if (db.observable) {
            if (db.observable.version !== "4.0.0-beta.13")
        ...
        db.observable = { version: "4.0.0-beta.13" };
    ...
    // 
    Observable.version = "4.0.0-beta.13";
    ...
    if (Dexie__default["default"].Observable) {
        if (Dexie__default["default"].Observable.version !== "4.0.0-beta.13") {
            throw new Error("Mixed versions of dexie-observable");
        }
    }
    else {
