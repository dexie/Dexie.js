 ...
 * ==========================================================================
 *
 * Version 3.0.0-beta.9, Tue Sep 29 2020
 *
 * http://dexie.org
 *
...
function Observable(db) {
    ...
    if (db.observable) {
        if (db.observable.version !== "3.0.0-beta.9")
    ...
    db.observable = { version: "3.0.0-beta.9" };
...
// 
Observable.version = "3.0.0-beta.9";
...
if (Dexie.Observable) {
    if (Dexie.Observable.version !== "3.0.0-beta.9") {
        throw new Error("Mixed versions of dexie-observable");
    }
}
else {
