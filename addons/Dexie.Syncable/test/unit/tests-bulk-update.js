...
asyncTest(
  "should ignore any changes for which we didn't find an object in the table",
  () => {
    const changes = [
      {
        key: 3,
...
asyncTest(
  'should update the object in the table according to the changes',
  () => {
    const updateKey1 = {
      key: 1,
      mods: { id: 1, foo: 'bar' },
