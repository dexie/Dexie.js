...
asyncTest(
  'should return relevant (between revision and maxRevision) changes',
  () => {
    const createChange1 = {
      rev: 1,
      key: 1,
...
asyncTest(
  'should set hasMoreToGive to true if we have more changes than maxChanges',
  () => {
    const createChange1 = {
      rev: 1,
      key: 1,
...
asyncTest(
  'should set hasMoreToGive to true but give no changes if maxChanges is 0',
  () => {
    const createChange1 = {
      rev: 1,
      key: 1,
