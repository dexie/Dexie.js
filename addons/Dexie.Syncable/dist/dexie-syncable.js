 ...
 * ==========================================================================
 *
 * Version 3.0.0-beta.10, Sun Dec 19 2021
 *
 * https://dexie.org
 *
...
(function (global, factory) {
    ...
    function Syncable(db) {
        ...
        if (!db.observable || (db.observable.version !== "3.0.0-beta.10" && !/^(3|4)\./.test(db.observable.version)))
    ...
    if (Dexie__default["default"].Syncable) {
        if (Dexie__default["default"].Syncable.version !== "3.0.0-beta.10") {
            throw new Error("Mixed versions of dexie-syncable");
        }
    }
    else {
