...
function Syncable(db) {
    ...
    if (!db.observable || (db.observable.version !== "3.0.0-beta.9" && !/^3\./.test(db.observable.version)))
        throw new Error("Missing dexie-observable version 3.x");
    if (db.syncable) {
        if (db.syncable.version !== "3.0.0-beta.9")
...
if (Dexie.Syncable) {
    if (Dexie.Syncable.version !== "3.0.0-beta.9") {
        throw new Error("Mixed versions of dexie-syncable");
    }
}
else {
