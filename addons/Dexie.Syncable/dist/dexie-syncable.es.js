...
function Syncable(db) {
    ...
    if (db.syncable) {
        if (db.syncable.version !== "{version}")
            throw new Error("Mixed versions of dexie-syncable: \"{version}\" vs \"".concat(db.syncable.version, "\""));
...
if (Dexie.Syncable) {
    if (Dexie.Syncable.version !== "{version}") {
        throw new Error("Mixed versions of dexie-syncable: \"{version}\" vs \"".concat(Dexie.Syncable.version, "\""));
    }
}
else {
