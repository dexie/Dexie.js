...
const DEXIE_VERSION = '3.2.0-beta.3';
...
const globalEvents = Events(null, "txcommitted");
...
function dexieOpen(db) {
    ...
    return DexiePromise.race([openCanceller, idbReady().then(() => new DexiePromise((resolve, reject) => {
            throwIfCancelled();
            if (!indexedDB)
                throw new exceptions.MissingAPI();
...
let propagateLocally = fireLocally;
