 ...
 *
 * Version 4.0.1-beta.4, Sat Dec 02 2023
 *
 * https://dexie.org
 *
...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DEXIE_VERSION = '4.0.1-beta.4';
        ...
        var observable = new Observable(function (observer) {
            ...
            function execute(ctx) {
                ...
                try {
                    ...
                    return Promise.resolve(rv).finally(function () {
                        if (PSD.subscr === ctx.subscr) {
                            console.warn("Dexie liveQuery()'s querier callback did'nt await all of its spawned promises. Querier source: ".concat(querier));
                            return new NativePromise(function (resolve) { return setTimeout(resolve, 0); });
                        }
                        else if (Promise.PSD) {
                            return new NativePromise(function (resolve) { return setTimeout(resolve, 0); });
                        }
