...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DEXIE_VERSION = '4.0.0-alpha.2';
        ...
        tableNames.forEach(function (tableName) {
            ...
            objs.forEach(function (obj) {
                ...
                if (!propDesc || ("value" in propDesc && (propDesc.value === undefined || propDesc.value instanceof Table))) {
                    ...
                    else if (obj instanceof Dexie$1) {
    ...
    function removeTablesApi(objs) {
        objs.forEach(function (obj) {
            (obj instanceof Dexie$1 ? [obj, obj._allTables] : [obj]).forEach(function (obj) {
                for (var key in obj) {
        ...
        versToRun.forEach(function (version) {
            queue.push(function () {
                ...
                if (contentUpgrade && version._cfg.version > oldVersion) {
                    ...
                    setApiOnPlace([db.Transaction.prototype], keys(upgradeSchema_1), upgradeSchema_1);
    ...
    var Dexie$1 =  (function () {
        function Dexie(name, options) {
            ...
            var vipDexie = Object.create(this);
            vipDexie._vip = true;
