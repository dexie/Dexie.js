       ...
       props(Transaction.prototype, {
           ...
           tables: {
               get: function () {
                   ...
                   return this._tables = this.storeNames.reduce(function (result, name) {
                       return result[name] = allTables[name], result;
                   }, {});
               }
           },
