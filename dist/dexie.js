 ...
 *
 * Version 3.1.0-alpha.4, Wed Nov 25 2020
 *
 * http://dexie.org
 *
...
var DEXIE_VERSION = '3.1.0-alpha.4';
        ...
        return __assign(__assign({}, core), { table: function (tableName) {
                ...
                var tableClone = __assign(__assign({}, table), { mutate: function (req) {
                        ...
                        return table.mutate(req).then(function (res) {
                            var _a, _b;
                            var mutatedParts = (_a = {}, _a[dbName] = (_b = {}, _b[tableName] = keys && keys.every(function (k) { return k != null; }) ? { keys: keys } : true, _b), _a);
                ...
                readSubscribers.forEach(function (_a) {
                    ...
                    tableClone[method] = function (req) {
                        var _a, _b;
                        if (PSD.subscr) {
                            var keys = getKeys && getKeys(req);
                            var observabilitySet = (_a = {}, _a[dbName] = (_b = {}, _b[tableName] = keys
                                        ?
                                            { keys: keys, cmp: core.cmp }
                                        :
                                            true, _b), _a);
