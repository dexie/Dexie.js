...
import { fullNameExceptions, mapError } from './errors';
import { DexieConstructor } from './public/types/dexie-constructor';
import { DatabaseLister } from './helpers/database-lister';
...
props(Dexie, {
  ...
  getDatabaseNames(cb) {
    return databaseLister ?
      databaseLister.getDatabaseNames().then(cb) :
      Promise.resolve([]);
  },
...
// Map DOMErrors and DOMExceptions to corresponding Dexie errors.
