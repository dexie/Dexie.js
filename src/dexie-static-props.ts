...
export function defineDexieStaticProperties (DexieConstructor: DexieConstructor) {
  let databaseEnumerator: DatabaseEnumerator | undefined;

  //
  // Set all static methods and properties onto Dexie:
  // 
  props(DexieConstructor, {
  ...
  // Initialize databaseLister
  try {
    databaseEnumerator = DatabaseEnumerator(DexieConstructor.dependencies.indexedDB);
