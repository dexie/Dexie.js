...
export interface Collection<T=any, TKey=IndexableType> {
  ...
  each(callback: (obj: Readonly<T>, cursor: {key: IndexableType, primaryKey: TKey}) => any): PromiseExtended<void>;
  ...
  first(): PromiseExtended<Readonly<T> | undefined>;
  first<R>(thenShortcut: ThenShortcut<Readonly<T> | undefined, R>): PromiseExtended<R>;
  ...
  last(): PromiseExtended<Readonly<T> | undefined>;
  last<R>(thenShortcut: ThenShortcut<Readonly<T> | undefined, R>): PromiseExtended<R>;
  ...
  sortBy(keyPath: string): PromiseExtended<ReadonlyArray<Readonly<T>>>;
  sortBy<R>(keyPath: string, thenShortcut: ThenShortcut<ReadonlyArray<Readonly<T>>, R>) : PromiseExtended<R>;
